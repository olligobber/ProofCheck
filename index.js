...
(function($PS) {
  ...
  var monadAppStateM = Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff);
  var modify = function (f) {
      return AppStateM(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff)))(function (ref) {
          return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect_Aff.monadAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.modify_(f)(ref)));
      }));
  };
  ...
  var get = AppStateM(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff)))(function (ref) {
      return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect_Aff.monadAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)));
  }));
  var functorAppStateM = Control_Monad_Reader_Trans.functorReaderT(Effect_Aff.functorAff);
  ...
  var bindAppStateM = Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff);
  var write = Control_Bind.bind(bindAppStateM)(get)(function (state) {
      ...
      return AppStateM(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect_Aff.monadAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.localStorage))(Web_Storage_Storage.setItem("proof")(string)))));
  });
  var readFileAppStateM = new UI_Capabilities.ReadFile(function () {
      return monadAppStateM;
  }, function (e) {
      return Control_Bind.bind(bindAppStateM)(get)(function (state) {
          return Control_Bind.discard(Control_Bind.discardUnit)(bindAppStateM)(AppStateM(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff)))(function (ref) {
              return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect_Aff.monadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Control_Promise.toAff(UI_File.readFile(e)))(function (string) {
                  return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                      ...
                      if (v instanceof Data_Either.Left) {
                          return Effect_Ref.modify_(function (v1) {
                              ...
                              $40.error = new Data_Maybe.Just([ "Error loading file: " + v.value0 ]);
                              return $40;
                          })(ref);
                      };
                      if (v instanceof Data_Either.Right) {
                          return Effect_Ref.modify_(function (v1) {
                              ...
                              $44.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)(state.history)([ state.present ]);
                              $44.future = [  ];
                              $44.present = v.value0;
                              $44.error = Data_Maybe.Nothing.value;
                              return $44;
                          })(ref);
                      };
  ...
  var writeSymbolsAppStateM = new UI_Capabilities.WriteSymbols(function () {
      ...
      return Control_Bind.bind(bindAppStateM)(get)(function (state) {
          ...
          throw new Error("Failed pattern match at UI.AppState (line 128, column 9 - line 140, column 30): " + [ v.constructor.name ]);
      });
  });                                                                               
...
(function($PS) {
  ...
  var run = function __do() {
      ...
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_VDom_Driver.runUI(Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(UI_AppState.run(ref))(component))(NoAction.value)))();
  };
  exports["run"] = run;
})(PS);
(function($PS) {
