      ...
      return function (v1) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Invalid line number in reason")(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)((function () {
              ...
              return Control_Bind.bind(Data_Either.bindEither)(Deduction_1.matchDeduction(antes)(v.value0.deduction)(v.value0.rule))(function (assumptions) {
                  ...
                  if (assumptions instanceof Data_Maybe.Just) {
                      return Data_Either.Left.create("Incorrect assumptions: " + Data_Show.show(Data_Set.showSet(Data_Show.showInt))(v.value0.assumptions));
                  };
                  if (Data_Set.size(v.value0.assumptions) !== 1) {
                      return Data_Either.Left.create("Wrong number of assumptions: " + Data_Show.show(Data_Show.showInt)(Data_Set.size(v.value0.assumptions)));
                  };
...
(function($PS) {
  ...
  var error = function (dictError) {
      var $26 = errors(dictError);
      var $27 = Control_Applicative.pure(Control_Applicative.applicativeArray);
      return function ($28) {
          return $26($27($28));
      };
  };
...
(function($PS) {
  ...
  var menu = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("menu") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName((function () {
          ...
          var $21 = Data_Eq.eq(UI_Capabilities.eqWindow)(state.window)(UI_Capabilities.SymbolWindow.value);
          if ($21) {
          ...
          var $22 = Data_Eq.eq(UI_Capabilities.eqWindow)(state.window)(UI_Capabilities.SequentWindow.value);
          if ($22) {
              return UI_Capabilities.NoWindow.value;
          };
          ...
          var $23 = Data_Eq.eq(UI_Capabilities.eqWindow)(state.window)(UI_Capabilities.IEWindow.value);
          if ($23) {
              return UI_Capabilities.NoWindow.value;
          };
              ...
              return function (dictHistory) {
                  return function (dictReadNav) {
                      return function (v) {
                          ...
                          throw new Error("Failed pattern match at UI (line 175, column 1 - line 181, column 56): " + [ v.constructor.name ]);
                      };
                  };
              };
          };
                                  ...
                                  return function (dictNav) {
                                      return function (state) {
                                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("main") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ menu(state), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                                              ...
                                              throw new Error("Failed pattern match at UI (line 165, column 10 - line 173, column 14): " + [ state.errors.constructor.name ]);
                                          })()));
                                      };
                                  };
                              };
  ...
  var run = function __do() {
      ...
      var start = (function () {
          ...
          if (pf instanceof Data_Maybe.Just) {
              ...
              if (v instanceof Data_Either.Right) {
                  ...
                  throw new Error("Failed pattern match at UI (line 207, column 28 - line 210, column 45): " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at UI (line 204, column 28 - line 210, column 45): " + [ v.constructor.name ]);
          };
          throw new Error("Failed pattern match at UI (line 202, column 17 - line 210, column 45): " + [ pf.constructor.name ]);
      })();
      ...
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_VDom_Driver.runUI(Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)((function () {
          var $36 = Effect_Class.liftEffect(Effect_Aff.monadEffectAff);
          var $37 = UI_AppState.run(ref);
          return function ($38) {
              return $36($37($38));
          };
