...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Mapping"] = $PS["Mapping"] || {};
  var exports = $PS["Mapping"];
  var Control_Category = $PS["Control.Category"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_HeytingAlgebra = $PS["Data.HeytingAlgebra"];
  ...
  var Mapping = (function () {
      function Mapping(value0) {
          this.value0 = value0;
      };
      Mapping.create = function (value0) {
          return new Mapping(value0);
      };
      return Mapping;
  })();
  var semigroupMapping = function (dictOrd) {
      return function (dictEq) {
          return new Data_Semigroup.Semigroup(function (v) {
              return function (v1) {
                  ...
                  if (v instanceof Mapping && v1 instanceof Mapping) {
                      var $8 = Data_Foldable.all(Data_Map_Internal.foldableMap)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Control_Category.identity(Control_Category.categoryFn))(Data_Map_Internal.intersectionWith(dictOrd)(Data_Eq.eq(dictEq))(v.value0)(v1.value0));
                      if ($8) {
                          return Mapping.create(Data_Map_Internal.union(dictOrd)(v.value0)(v1.value0));
                      };
                      return None.value;
                  };
                  throw new Error("Failed pattern match at Mapping (line 14, column 1 - line 21, column 17): " + [ v.constructor.name, v1.constructor.name ]);
              };
          });
      };
  };
  var monoidMapping = function (dictOrd) {
      return function (dictEq) {
          return new Data_Monoid.Monoid(function () {
              return semigroupMapping(dictOrd)(dictEq);
          }, Mapping.create(Data_Map_Internal.empty));
      };
  };
  exports["None"] = None;
  exports["Mapping"] = Mapping;
  exports["semigroupMapping"] = semigroupMapping;
  exports["monoidMapping"] = monoidMapping;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  ...
  var Mapping = $PS["Mapping"];                
  var BMap = (function () {
      function BMap(value0) {
          this.value0 = value0;
      };
      BMap.create = function (value0) {
          return new BMap(value0);
      };
      return BMap;
  })();
  var Prop = (function () {
  ...
  var Unary = (function () {
      function Unary(value0) {
          this.value0 = value0;
      };
      Unary.create = function (value0) {
          return new Unary(value0);
      };
      return Unary;
  })();
  var Binary = (function () {
  ...
  var render = function (v) {
      ...
      if (v instanceof Unary) {
          return v.value0.operator.symbol + safeRender(v.value0.contents);
      };
      if (v instanceof Binary) {
          return safeRender(v.value0.left) + (v.value0.operator.symbol + safeRender(v.value0.right));
      };
      throw new Error("Failed pattern match at WFF (line 130, column 1 - line 130, column 31): " + [ v.constructor.name ]);
  };
  var makeUnary = function (f) {
  ...
  var negOp = makeUnary(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))("~");
  ...
  var liftIso = function (dictFunctor) {
      return function (i) {
          return function (dictProfunctor) {
              return Data_Lens_Iso.iso(Data_Functor.map(dictFunctor)(Data_Lens_Getter.view(i(Data_Lens_Internal_Forget.profunctorForget))))(Data_Functor.map(dictFunctor)(Data_Lens_Prism.review(i(Data_Lens_Internal_Tagged.taggedProfunctor))))(dictProfunctor);
          };
      };
  };
  var functorWFF = new Data_Functor.Functor(function (f) {
      return function (v) {
          if (v instanceof Prop) {
              return Prop.create(f(v.value0));
          };
          if (v instanceof Unary) {
              return Unary.create({
                  operator: v.value0.operator,
                  contents: Data_Functor.map(functorWFF)(f)(v.value0.contents)
              });
          };
          if (v instanceof Binary) {
              return Binary.create({
                  operator: v.value0.operator,
                  left: Data_Functor.map(functorWFF)(f)(v.value0.left),
                  right: Data_Functor.map(functorWFF)(f)(v.value0.right)
              });
          };
          throw new Error("Failed pattern match at WFF (line 91, column 1 - line 95, column 65): " + [ f.constructor.name, v.constructor.name ]);
      };
  });
  var foldableWFF = new Data_Foldable.Foldable(function (dictMonoid) {
      return function (f) {
          return function (v) {
              if (v instanceof Prop) {
                  return f(v.value0);
              ...
              if (v instanceof Unary) {
                  return Data_Foldable.foldMap(foldableWFF)(dictMonoid)(f)(v.value0.contents);
              };
              if (v instanceof Binary) {
                  return Data_Semigroup.append(dictMonoid.Semigroup0())(Data_Foldable.foldMap(foldableWFF)(dictMonoid)(f)(v.value0.left))(Data_Foldable.foldMap(foldableWFF)(dictMonoid)(f)(v.value0.right));
              };
              throw new Error("Failed pattern match at WFF (line 114, column 1 - line 119, column 37): " + [ f.constructor.name, v.constructor.name ]);
          };
      };
  }, function (f) {
      return function (x) {
          return function (y) {
              return Data_Foldable.foldlDefault(foldableWFF)(f)(x)(y);
          };
      };
  }, function (f) {
      return function (x) {
          return function (y) {
              return Data_Foldable.foldrDefault(foldableWFF)(f)(x)(y);
          };
      };
  });
  var traversableWFF = new Data_Traversable.Traversable(function () {
      return foldableWFF;
  }, function () {
      return functorWFF;
  }, function (dictApplicative) {
      return function (v) {
          if (v instanceof Prop) {
              return Data_Functor.map((dictApplicative.Apply0()).Functor0())(Prop.create)(v.value0);
          };
          if (v instanceof Unary) {
              return Data_Functor.map((dictApplicative.Apply0()).Functor0())(function ($152) {
              ...
              })(Data_Traversable.sequence(traversableWFF)(dictApplicative)(v.value0.contents));
          };
          if (v instanceof Binary) {
              ...
              })(Data_Traversable.sequence(traversableWFF)(dictApplicative)(v.value0.left)))(Data_Traversable.sequence(traversableWFF)(dictApplicative)(v.value0.right)));
          };
          throw new Error("Failed pattern match at WFF (line 121, column 1 - line 127, column 31): " + [ v.constructor.name ]);
      };
  }, function (dictApplicative) {
      return Data_Traversable.traverseDefault(traversableWFF)(dictApplicative);
  });
  var eqBoolFunction = function (dictEq) {
      return new Data_Eq.Eq(function (v) {
          return function (v1) {
              return Data_Eq.eq(dictEq)(v.value0(true))(v1.value0(true)) && Data_Eq.eq(dictEq)(v.value0(false))(v1.value0(false));
          };
      });
  };
  var eqWFF = function (dictEq) {
      return new Data_Eq.Eq(function (x) {
          return function (y) {
              if (x instanceof Prop && y instanceof Prop) {
                  return Data_Eq.eq(dictEq)(x.value0)(y.value0);
              };
              if (x instanceof Unary && y instanceof Unary) {
                  return Data_Eq.eq(eqWFF(dictEq))(x.value0.contents)(y.value0.contents) && (Data_Eq.eq(eqBoolFunction(Data_Eq.eqBoolean))(x["value0"]["operator"]["function"])(y["value0"]["operator"]["function"]) && x.value0.operator.symbol === y.value0.operator.symbol);
              };
              if (x instanceof Binary && y instanceof Binary) {
                  return Data_Eq.eq(eqWFF(dictEq))(x.value0.left)(y.value0.left) && (Data_Eq.eq(eqBoolFunction(eqBoolFunction(Data_Eq.eqBoolean)))(x["value0"]["operator"]["function"])(y["value0"]["operator"]["function"]) && x.value0.operator.symbol === y.value0.operator.symbol) && Data_Eq.eq(eqWFF(dictEq))(x.value0.right)(y.value0.right);
              };
              return false;
          };
      });
  };
  var match = function (dictOrd) {
      return function (dictEq) {
          return function (v) {
              return function (v1) {
                  if (v instanceof Prop) {
                      return Mapping.Mapping.create(Data_Map_Internal.singleton(v.value0)(v1));
                  };
                  if (v instanceof Unary && (v1 instanceof Unary && Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                      return "symbol";
                  }))(Data_Eq.eqString))()(new Data_Symbol.IsSymbol(function () {
                      return "function";
                  }))(eqBoolFunction(Data_Eq.eqBoolean))))(v.value0.operator)(v1.value0.operator))) {
                      return match(dictOrd)(dictEq)(v.value0.contents)(v1.value0.contents);
                  };
                  if (v instanceof Binary && (v1 instanceof Binary && Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                      return "symbol";
                  }))(Data_Eq.eqString))()(new Data_Symbol.IsSymbol(function () {
                      return "function";
                  }))(eqBoolFunction(eqBoolFunction(Data_Eq.eqBoolean)))))(v.value0.operator)(v1.value0.operator))) {
                      return Data_Semigroup.append(Mapping.semigroupMapping(dictOrd)(eqWFF(dictEq)))(match(dictOrd)(dictEq)(v.value0.left)(v1.value0.left))(match(dictOrd)(dictEq)(v.value0.right)(v1.value0.right));
                  };
                  return Mapping.None.value;
              };
          };
      };
  };
  var ordBoolFunction = function (dictOrd) {
      return new Data_Ord.Ord(function () {
          return eqBoolFunction(dictOrd.Eq0());
      }, function (v) {
          return function (v1) {
              return Data_Ord.compare(Data_Ord.ordArray(dictOrd))([ v.value0(true), v.value0(false) ])([ v1.value0(true), v1.value0(false) ]);
          };
      });
  };
  var ordWFF = function (dictOrd) {
      return new Data_Ord.Ord(function () {
          return eqWFF(dictOrd.Eq0());
      }, function (x) {
          return function (y) {
              if (x instanceof Prop && y instanceof Prop) {
                  return Data_Ord.compare(dictOrd)(x.value0)(y.value0);
              ...
              if (y instanceof Prop) {
                  return Data_Ordering.GT.value;
              };
              if (x instanceof Unary && y instanceof Unary) {
                  var v = Data_Ord.compare(ordWFF(dictOrd))(x.value0.contents)(y.value0.contents);
                  if (v instanceof Data_Ordering.LT) {
                      return Data_Ordering.LT.value;
                  };
                  if (v instanceof Data_Ordering.GT) {
                  ...
                  var v1 = Data_Ord.compare(ordBoolFunction(Data_Ord.ordBoolean))(x["value0"]["operator"]["function"])(y["value0"]["operator"]["function"]);
                  ...
                  return Data_Ord.compare(Data_Ord.ordString)(x.value0.operator.symbol)(y.value0.operator.symbol);
              };
              ...
              if (x instanceof Binary && y instanceof Binary) {
                  var v = Data_Ord.compare(ordWFF(dictOrd))(x.value0.left)(y.value0.left);
                  if (v instanceof Data_Ordering.LT) {
                      return Data_Ordering.LT.value;
                  };
                  if (v instanceof Data_Ordering.GT) {
                  ...
                  var v1 = (function () {
                      var v2 = Data_Ord.compare(ordBoolFunction(ordBoolFunction(Data_Ord.ordBoolean)))(x["value0"]["operator"]["function"])(y["value0"]["operator"]["function"]);
                      if (v2 instanceof Data_Ordering.LT) {
                          return Data_Ordering.LT.value;
                      };
                      if (v2 instanceof Data_Ordering.GT) {
                  ...
                  return Data_Ord.compare(ordWFF(dictOrd))(x.value0.right)(y.value0.right);
              };
              throw new Error("Failed pattern match at WFF (line 84, column 1 - line 84, column 47): " + [ x.constructor.name, y.constructor.name ]);
          };
      });
  };
  var bmap = function (dictProfunctor) {
      return Data_Lens_Iso.iso(function (v) {
          return v.value0;
      })(BMap.create)(dictProfunctor);
  };
  var bmapmap = function (dictProfunctor) {
      var $153 = bmap(dictProfunctor);
      var $154 = liftIso(Data_Functor.functorFn)(function (dictProfunctor1) {
          return bmap(dictProfunctor1);
      })(dictProfunctor);
      return function ($155) {
          return $153($154($155));
      };
  };
  var makeBinary = function (f) {
      return function (symbol) {
          return {
              "function": Data_Lens_Prism.review(bmapmap(Data_Lens_Internal_Tagged.taggedProfunctor))(f),
              symbol: symbol
          };
      };
  };
  var impliesOp = makeBinary(Data_Ord.lessThanOrEq(Data_Ord.ordBoolean))("->");
  ...
  var orOp = makeBinary(Data_HeytingAlgebra.disj(Data_HeytingAlgebra.heytingAlgebraBoolean))("|");
  ...
  var $$eval = function (v) {
      ...
      if (v instanceof Unary) {
          return Data_Lens_Getter.view(bmap(Data_Lens_Internal_Forget.profunctorForget))(v["value0"]["operator"]["function"])($$eval(v.value0.contents));
      };
      if (v instanceof Binary) {
          return Data_Lens_Getter.view(bmapmap(Data_Lens_Internal_Forget.profunctorForget))(v["value0"]["operator"]["function"])($$eval(v.value0.left))($$eval(v.value0.right));
      };
      throw new Error("Failed pattern match at WFF (line 141, column 1 - line 141, column 31): " + [ v.constructor.name ]);
  }; 
  var andOp = makeBinary(Data_HeytingAlgebra.conj(Data_HeytingAlgebra.heytingAlgebraBoolean))("&");
  ...
  exports["match"] = match;
  exports["eqBoolFunction"] = eqBoolFunction;
  exports["ordBoolFunction"] = ordBoolFunction;
  exports["eqWFF"] = eqWFF;
  exports["ordWFF"] = ordWFF;
  exports["functorWFF"] = functorWFF;
  exports["traversableWFF"] = traversableWFF;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Sequent"] = $PS["Sequent"] || {};
  var exports = $PS["Sequent"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  var Data_Boolean = $PS["Data.Boolean"];
  ...
  var Sequent = (function () {
      function Sequent(value0) {
          this.value0 = value0;
      };
      Sequent.create = function (value0) {
          return new Sequent(value0);
      };
      return Sequent;
  })();
  var render = function (v) {
      return Data_String_Common.joinWith(",")(Data_Functor.map(Data_Functor.functorArray)(WFF.render)(v.value0.ante)) + (" \u22a2 " + WFF.render(v.value0.conse));
  };
  var permute = function (dictEq) {
      return function (v) {
          if (v.length === 0) {
              return [ [  ] ];
          };
          return Control_Bind.bind(Control_Bind.bindArray)(v)(function (h) {
              return Control_Bind.bind(Control_Bind.bindArray)(permute(dictEq)(Data_Array["delete"](dictEq)(h)(v)))(function (t) {
                  return Control_Applicative.pure(Control_Applicative.applicativeArray)(Data_Array.cons(h)(t));
              });
          });
      };
  };
  var match1 = function (dictOrd) {
      return function (dictEq) {
          return function (v) {
              return function (v1) {
                  return Data_Semigroup.append(Mapping.semigroupMapping(dictOrd)(WFF.eqWFF(dictEq)))(Data_Foldable.fold(Data_Foldable.foldableArray)(Mapping.monoidMapping(dictOrd)(WFF.eqWFF(dictEq)))(Data_Array.zipWith(WFF.match(dictOrd)(dictEq))(v.value0.ante)(v1.value0.ante)))(WFF.match(dictOrd)(dictEq)(v.value0.conse)(v1.value0.conse));
              };
          };
      };
  };
      ...
      return function (dictEq) {
          return function (dictEq1) {
              return function (indices) {
                  return function (v) {
                      return function (v1) {
                          if (Data_Array.length(v.value0.ante) === Data_Array.length(v1.value0.ante)) {
                              var indexedAnte = Data_Array.zip(indices)(v1.value0.ante);
                              return Control_Bind.bind(Control_Bind.bindArray)(Data_Functor.map(Data_Functor.functorArray)(Data_Array.unzip)(permute(Data_Tuple.eqTuple(dictEq1)(WFF.eqWFF(dictEq)))(indexedAnte)))(function (v2) {
                                  var v3 = match1(dictOrd)(dictEq)(new Sequent(v.value0))(Sequent.create({
                                      ante: v2.value1,
                                      conse: v1.value0.conse
                                  }));
                                  if (v3 instanceof Mapping.Mapping) {
                                      return [ {
                                          permutation: v2.value0,
                                          substitution: v3.value0
                                      } ];
                                  };
                                  if (v3 instanceof Mapping.None) {
                                      return [  ];
                                  };
                                  throw new Error("Failed pattern match at Sequent (line 87, column 9 - line 89, column 23): " + [ v3.constructor.name ]);
                              });
                          };
                          if (Data_Boolean.otherwise) {
                              return [  ];
                          };
                          throw new Error("Failed pattern match at Sequent (line 81, column 1 - line 82, column 79): " + [ indices.constructor.name, v.constructor.name, v1.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var functorSequent = new Data_Functor.Functor(function (f) {
      return function (v) {
          return new Sequent({
              ante: Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map(WFF.functorWFF)(f))(v.value0.ante),
              conse: Data_Functor.map(WFF.functorWFF)(f)(v.value0.conse)
          });
      };
  });
  var eqSequent = function (dictEq) {
      return new Data_Eq.Eq(function (x) {
          return function (y) {
              return Data_Eq.eq(Data_Eq.eqArray(WFF.eqWFF(dictEq)))(x.value0.ante)(y.value0.ante) && Data_Eq.eq(WFF.eqWFF(dictEq))(x.value0.conse)(y.value0.conse);
          };
      });
  };
  var ordSequent = function (dictOrd) {
      return new Data_Ord.Ord(function () {
          return eqSequent(dictOrd.Eq0());
      }, function (x) {
          return function (y) {
              var v = Data_Ord.compare(Data_Ord.ordArray(WFF.ordWFF(dictOrd)))(x.value0.ante)(y.value0.ante);
              if (v instanceof Data_Ordering.LT) {
                  return Data_Ordering.LT.value;
              };
              if (v instanceof Data_Ordering.GT) {
              ...
              return Data_Ord.compare(WFF.ordWFF(dictOrd))(x.value0.conse)(y.value0.conse);
          };
      });
  };
  ...
  exports["functorSequent"] = functorSequent;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Symbol"] = $PS["Symbol"] || {};
  var exports = $PS["Symbol"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_Either = $PS["Data.Either"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Foldable = $PS["Data.Foldable"];
  ...
  var WFF = $PS["WFF"];                
  var UnarySymbol = (function () {
      function UnarySymbol(value0) {
          this.value0 = value0;
      };
      UnarySymbol.create = function (value0) {
          return new UnarySymbol(value0);
      };
      return UnarySymbol;
  })();
  var BinarySymbol = (function () {
      function BinarySymbol(value0) {
          this.value0 = value0;
      };
      BinarySymbol.create = function (value0) {
          return new BinarySymbol(value0);
      };
      return BinarySymbol;
  })();
  var updateMap = function (m) {
      return function (v) {
          if (v instanceof UnarySymbol) {
              if (Data_Map_Internal.member(Data_Ord.ordString)(v.value0.operator.symbol)(m)) {
                  return Data_Either.Left.create("Symbol " + (v.value0.operator.symbol + " is already defined"));
              };
              if (Data_Boolean.otherwise) {
                  return Data_Either.Right.create(Data_Map_Internal.insert(Data_Ord.ordString)(v.value0.operator.symbol)(new Data_Either.Left(v.value0.operator))(m));
              };
          };
          if (v instanceof BinarySymbol) {
              ...
              if (Data_Boolean.otherwise) {
                  return Data_Either.Right.create(Data_Map_Internal.insert(Data_Ord.ordString)(v.value0.operator.symbol)(new Data_Either.Right(v.value0.operator))(m));
              };
          };
          throw new Error("Failed pattern match at Symbol (line 91, column 1 - line 91, column 60): " + [ m.constructor.name, v.constructor.name ]);
      };
  };
  var toSequents = function (v) {
      if (v instanceof UnarySymbol) {
          var withOp = new WFF.Unary({
              operator: v.value0.operator,
              contents: new WFF.Prop(1)
          });
          var noOp = Data_Functor.voidRight(WFF.functorWFF)(1)(v.value0.definition);
      ...
      if (v instanceof BinarySymbol) {
          var withOp = new WFF.Binary({
              operator: v.value0.operator,
              left: new WFF.Prop(1),
              right: new WFF.Prop(0)
          });
          var noOp = Data_Functor.map(WFF.functorWFF)(function (v1) {
              if (v1) {
                  return 1;
              };
              return 0;
      ...
      throw new Error("Failed pattern match at Symbol (line 61, column 1 - line 61, column 44): " + [ v.constructor.name ]);
  };
  var makeUnary = function (dictEq) {
      return function (p) {
          return function (s) {
              return function (w) {
                  var renamed = Data_Traversable.traverse(WFF.traversableWFF)(Data_Maybe.applicativeMaybe)(function (q) {
                      var $35 = Data_Eq.eq(dictEq)(p)(q);
                      if ($35) {
                          return new Data_Maybe.Just(Data_Unit.unit);
                      };
                      return Data_Maybe.Nothing.value;
                  })(w);
                  if (renamed instanceof Data_Maybe.Just) {
                      return Data_Either.Right.create(new UnarySymbol({
                          operator: WFF.makeUnary(function (b) {
                              return WFF["eval"](Data_Functor.voidRight(WFF.functorWFF)(b)(renamed.value0));
                          })(s),
                          definition: renamed.value0
                      }));
                  };
                  if (renamed instanceof Data_Maybe.Nothing) {
                      return new Data_Either.Left("Extra proposition(s) found in symbol definition");
                  };
                  throw new Error("Failed pattern match at Symbol (line 34, column 19 - line 39, column 70): " + [ renamed.constructor.name ]);
              };
          };
      };
  };
  var makeBinary = function (dictEq) {
      return function (p) {
          return function (q) {
              return function (s) {
                  return function (w) {
                      var renamed = Data_Traversable.traverse(WFF.traversableWFF)(Data_Maybe.applicativeMaybe)(function (r) {
                          var $38 = Data_Eq.eq(dictEq)(p)(r);
                          if ($38) {
                              return new Data_Maybe.Just(true);
                          };
                          var $39 = Data_Eq.eq(dictEq)(q)(r);
                          if ($39) {
                      ...
                      if (renamed instanceof Data_Maybe.Just) {
                          return Data_Either.Right.create(new BinarySymbol({
                              operator: WFF.makeBinary(function (a) {
                                  return function (b) {
                                      return WFF["eval"](Data_Functor.map(WFF.functorWFF)(function (v) {
                                          if (v) {
                                              return a;
                                          };
                                          return b;
                      ...
                      throw new Error("Failed pattern match at Symbol (line 45, column 22 - line 52, column 70): " + [ renamed.constructor.name ]);
                  };
              };
          };
      };
  ...
  var getName = function (v) {
      if (v instanceof UnarySymbol) {
          return v.value0.operator.symbol;
      };
      if (v instanceof BinarySymbol) {
          return v.value0.operator.symbol;
      };
      throw new Error("Failed pattern match at Symbol (line 77, column 1 - line 77, column 28): " + [ v.constructor.name ]);
  };
  var eqSymbol = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof UnarySymbol && y instanceof UnarySymbol) {
              return Data_Eq.eq(WFF.eqWFF(Data_Eq.eqUnit))(x.value0.definition)(y.value0.definition) && (Data_Eq.eq(WFF.eqBoolFunction(Data_Eq.eqBoolean))(x["value0"]["operator"]["function"])(y["value0"]["operator"]["function"]) && x.value0.operator.symbol === y.value0.operator.symbol);
          };
          if (x instanceof BinarySymbol && y instanceof BinarySymbol) {
              return Data_Eq.eq(WFF.eqWFF(Data_Eq.eqBoolean))(x.value0.definition)(y.value0.definition) && (Data_Eq.eq(WFF.eqBoolFunction(WFF.eqBoolFunction(Data_Eq.eqBoolean)))(x["value0"]["operator"]["function"])(y["value0"]["operator"]["function"]) && x.value0.operator.symbol === y.value0.operator.symbol);
          };
          return false;
      };
  });
  var ordSymbol = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          if (x instanceof UnarySymbol && y instanceof UnarySymbol) {
              var v = Data_Ord.compare(WFF.ordWFF(Data_Ord.ordUnit))(x.value0.definition)(y.value0.definition);
              if (v instanceof Data_Ordering.LT) {
                  return Data_Ordering.LT.value;
              };
              if (v instanceof Data_Ordering.GT) {
              ...
              var v1 = Data_Ord.compare(WFF.ordBoolFunction(Data_Ord.ordBoolean))(x["value0"]["operator"]["function"])(y["value0"]["operator"]["function"]);
              if (v1 instanceof Data_Ordering.LT) {
                  return Data_Ordering.LT.value;
              };
              if (v1 instanceof Data_Ordering.GT) {
          ...
          if (x instanceof UnarySymbol) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof UnarySymbol) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof BinarySymbol && y instanceof BinarySymbol) {
              var v = Data_Ord.compare(WFF.ordWFF(Data_Ord.ordBoolean))(x.value0.definition)(y.value0.definition);
              if (v instanceof Data_Ordering.LT) {
                  return Data_Ordering.LT.value;
              };
              if (v instanceof Data_Ordering.GT) {
              ...
              var v1 = Data_Ord.compare(WFF.ordBoolFunction(WFF.ordBoolFunction(Data_Ord.ordBoolean)))(x["value0"]["operator"]["function"])(y["value0"]["operator"]["function"]);
              if (v1 instanceof Data_Ordering.LT) {
                  return Data_Ordering.LT.value;
              };
              if (v1 instanceof Data_Ordering.GT) {
          ...
          throw new Error("Failed pattern match at Symbol (line 31, column 1 - line 31, column 40): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var defaultMap = Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)([ Data_Tuple.Tuple.create("&")(new Data_Either.Right(WFF.andOp)), Data_Tuple.Tuple.create("|")(new Data_Either.Right(WFF.orOp)), Data_Tuple.Tuple.create("->")(new Data_Either.Right(WFF.impliesOp)), Data_Tuple.Tuple.create("~")(new Data_Either.Left(WFF.negOp)) ]);
...
(function($PS) {
  ...
  var OrIntroduction = (function () {
      ...
      OrIntroduction.value = new OrIntroduction();
      return OrIntroduction;
  })();
  var OrElimination = (function () {
      function OrElimination() {
  ...
  var Definition = (function () {
      ...
      Definition.create = function (value0) {
          return function (value1) {
              return new Definition(value0, value1);
          };
      };
      return Definition;
  })();
  var Introduction = (function () {
      function Introduction(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Introduction.create = function (value0) {
          return function (value1) {
              return new Introduction(value0, value1);
          };
      };
      return Introduction;
  })();
  var toSequents = function (v) {
      if (v instanceof Assumption) {
          return [ Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create)(new Sequent.Sequent({
              ante: [  ],
              conse: new WFF.Prop(1)
          })) ];
      };
      if (v instanceof ModusPonens) {
          return [ Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create)(new Sequent.Sequent({
              ante: [ new WFF.Prop(1), WFF.implies(new WFF.Prop(1))(new WFF.Prop(2)) ],
              conse: new WFF.Prop(2)
          })) ];
      };
      if (v instanceof ModusTollens) {
          return Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create))([ new Sequent.Sequent({
              ante: [ WFF.neg(new WFF.Prop(2)), WFF.implies(new WFF.Prop(1))(new WFF.Prop(2)) ],
              conse: WFF.neg(new WFF.Prop(1))
          }) ]);
      };
      if (v instanceof DoubleNegation) {
          return [ Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create)(new Sequent.Sequent({
              ante: [ new WFF.Prop(1) ],
              conse: WFF.neg(WFF.neg(new WFF.Prop(1)))
          })), Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create)(new Sequent.Sequent({
              ante: [ WFF.neg(WFF.neg(new WFF.Prop(1))) ],
              conse: new WFF.Prop(1)
          })) ];
      };
      if (v instanceof ConditionalProof) {
          return [ Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create)(new Sequent.Sequent({
              ante: [ new WFF.Prop(1), new WFF.Prop(2) ],
              conse: WFF.implies(new WFF.Prop(1))(new WFF.Prop(2))
          })) ];
      };
      if (v instanceof AndIntroduction) {
          return [ Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create)(new Sequent.Sequent({
              ante: [ new WFF.Prop(1), new WFF.Prop(2) ],
              conse: WFF.and(new WFF.Prop(1))(new WFF.Prop(2))
          })) ];
      };
      if (v instanceof AndElimination) {
          return [ Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create)(new Sequent.Sequent({
              ante: [ WFF.and(new WFF.Prop(1))(new WFF.Prop(2)) ],
              conse: new WFF.Prop(1)
          })), Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create)(new Sequent.Sequent({
              ante: [ WFF.and(new WFF.Prop(1))(new WFF.Prop(2)) ],
              conse: new WFF.Prop(2)
      ...
      if (v instanceof OrIntroduction) {
          return [ Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create)(new Sequent.Sequent({
              ante: [ new WFF.Prop(1) ],
              conse: WFF.or(new WFF.Prop(1))(new WFF.Prop(2))
          })), Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create)(new Sequent.Sequent({
              ante: [ new WFF.Prop(2) ],
              conse: WFF.or(new WFF.Prop(1))(new WFF.Prop(2))
          })) ];
      ...
      if (v instanceof OrElimination) {
          return [ Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create)(new Sequent.Sequent({
              ante: [ new WFF.Prop(1), new WFF.Prop(2), WFF.or(new WFF.Prop(1))(new WFF.Prop(2)), new WFF.Prop(3), new WFF.Prop(3) ],
              conse: new WFF.Prop(3)
          })) ];
      };
      if (v instanceof RAA) {
          return Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create))([ new Sequent.Sequent({
              ante: [ new WFF.Prop(1), WFF.and(new WFF.Prop(2))(WFF.neg(new WFF.Prop(2))) ],
              conse: WFF.neg(new WFF.Prop(1))
          }) ]);
      };
      if (v instanceof Definition) {
          return Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map(Sequent.functorSequent)(Data_Either.Left.create))($$Symbol.toSequents(v.value0));
      };
      if (v instanceof Introduction) {
          return [ Data_Functor.map(Sequent.functorSequent)(Data_Either.Right.create)(v.value0) ];
      };
      throw new Error("Failed pattern match at Deduction (line 64, column 1 - line 64, column 67): " + [ v.constructor.name ]);
  };
  var renderRule = function (v) {
      ...
      if (v instanceof Definition && v.value0 instanceof $$Symbol.UnarySymbol) {
          return "Def (" + (v.value0.value0.operator.symbol + ")");
      };
      if (v instanceof Definition && v.value0 instanceof $$Symbol.BinarySymbol) {
          return "Def (" + (v.value0.value0.operator.symbol + ")");
      };
      if (v instanceof Introduction) {
          ...
          return function (v) {
              if (v instanceof Assumption) {
                  var v1 = Data_Array.head(Control_Bind.bind(Control_Bind.bindArray)(toSequents(v))(function (s) {
                      return Sequent.match(Data_Either.ordEither(Data_Ord.ordInt)(Data_Ord.ordString))(Data_Eq.eqString)(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                          return "isAssumption";
                      }))(Data_Eq.eqBoolean))()(new Data_Symbol.IsSymbol(function () {
                          return "formula";
                      }))(WFF.eqWFF(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
                          return "assumptions";
                  ...
                  throw new Error("Failed pattern match at Deduction (line 110, column 5 - line 115, column 32): " + [ v1.constructor.name ]);
              };
              if (v instanceof ConditionalProof) {
                  var v1 = Data_Array.head(Control_Bind.bind(Control_Bind.bindArray)(toSequents(v))(function (s) {
                      return Control_Bind.bind(Control_Bind.bindArray)(Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                          return v2.permutation;
                      })(Sequent.match(Data_Either.ordEither(Data_Ord.ordInt)(Data_Ord.ordString))(Data_Eq.eqString)(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                          return "isAssumption";
                      }))(Data_Eq.eqBoolean))()(new Data_Symbol.IsSymbol(function () {
                          return "formula";
                      }))(WFF.eqWFF(Data_Eq.eqString)))()(new Data_Symbol.IsSymbol(function () {
                          ...
                          return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.fromFoldable(Data_Foldable.foldableMaybe)(Data_Array.index(perm)(0)))(function (assumption) {
                              return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.fromFoldable(Data_Foldable.foldableMaybe)(Data_Array.index(perm)(1)))(function (conclusion) {
              ...
              if (v instanceof OrElimination) {
                  var v1 = Data_Array.head(Control_Bind.bind(Control_Bind.bindArray)(toSequents(v))(function (s) {
                      return Control_Bind.bind(Control_Bind.bindArray)(Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                          ...
                          return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.fromFoldable(Data_Foldable.foldableMaybe)(Data_Array.index(perm)(0)))(function (firstA) {
                              return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.fromFoldable(Data_Foldable.foldableMaybe)(Data_Array.index(perm)(1)))(function (secondA) {
                                  return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.fromFoldable(Data_Foldable.foldableMaybe)(Data_Array.index(perm)(2)))(function (orA) {
                                      return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.fromFoldable(Data_Foldable.foldableMaybe)(Data_Array.index(perm)(3)))(function (firstC) {
                                          return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.fromFoldable(Data_Foldable.foldableMaybe)(Data_Array.index(perm)(4)))(function (secondC) {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Bind.bindArray)(Control_MonadZero.guard(Control_MonadZero.monadZeroArray)(firstA.isAssumption))(function () {
              ...
              if (v instanceof RAA) {
                  var v1 = Data_Array.head(Control_Bind.bind(Control_Bind.bindArray)(toSequents(v))(function (s) {
                      return Control_Bind.bind(Control_Bind.bindArray)(Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                          ...
                          return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.fromFoldable(Data_Foldable.foldableMaybe)(Data_Array.index(perm)(0)))(function (assumption) {
                              return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.fromFoldable(Data_Foldable.foldableMaybe)(Data_Array.index(perm)(1)))(function (contradiction) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Bind.bindArray)(Control_MonadZero.guard(Control_MonadZero.monadZeroArray)(assumption.isAssumption))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Bind.bindArray)(Control_MonadZero.guard(Control_MonadZero.monadZeroArray)(Data_Set.subset(Data_Ord.ordInt)(assumption.assumptions)(contradiction.assumptions)))(function () {
                                          return Control_Applicative.pure(Control_Applicative.applicativeArray)(Data_Set.difference(Data_Ord.ordInt)(contradiction.assumptions)(assumption.assumptions));
                                      });
                                  });
                              });
                          });
  ...
  var isAssumption = function (v) {
      if (v instanceof Assumption) {
          return true;
      };
      return false;
  };
  var eqDeductionRule = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof Definition && y instanceof Definition) {
              return Data_Eq.eq($$Symbol.eqSymbol)(x.value0)(y.value0) && x.value1 === y.value1;
          };
          if (x instanceof Introduction && y instanceof Introduction) {
              return Data_Eq.eq(Sequent.eqSequent(Data_Eq.eqString))(x.value0)(y.value0) && x.value1 === y.value1;
          };
          return false;
      };
  });
  var ordDeductionRule = new Data_Ord.Ord(function () {
      return eqDeductionRule;
  }, function (x) {
      return function (y) {
          if (x instanceof Assumption && y instanceof Assumption) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof Assumption) {
              return Data_Ordering.LT.value;
          };
          ...
          if (x instanceof AndIntroduction) {
              return Data_Ordering.LT.value;
          };
          ...
          if (x instanceof OrIntroduction) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof OrIntroduction) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof OrElimination && y instanceof OrElimination) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof OrElimination) {
              return Data_Ordering.LT.value;
          };
          ...
          if (x instanceof Definition && y instanceof Definition) {
              var v = Data_Ord.compare($$Symbol.ordSymbol)(x.value0)(y.value0);
              if (v instanceof Data_Ordering.LT) {
                  return Data_Ordering.LT.value;
              };
              if (v instanceof Data_Ordering.GT) {
          ...
          if (y instanceof Definition) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof Introduction && y instanceof Introduction) {
              var v = Data_Ord.compare(Sequent.ordSequent(Data_Ord.ordString))(x.value0)(y.value0);
              if (v instanceof Data_Ordering.LT) {
                  return Data_Ordering.LT.value;
              };
              if (v instanceof Data_Ordering.GT) {
          ...
          throw new Error("Failed pattern match at Deduction (line 41, column 1 - line 41, column 54): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  exports["eqDeductionRule"] = eqDeductionRule;
  exports["ordDeductionRule"] = ordDeductionRule;
})(PS);
(function(exports) {
...
(function($PS) {
  ...
  var definedSymbol = function (m) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.position(Data_Identity.monadIdentity))(function (p) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(symbol)(function (s) {
              var v = Data_Map_Internal.lookup(Data_Ord.ordString)(s)(m);
              if (v instanceof Data_Maybe.Just) {
      ...
      return function (m) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(safeExpression(dictLazy)(m))(function (left) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.option(Data_Identity.monadIdentity)(Data_Maybe.Nothing.value)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Maybe.Just.create)(tailBinaryExpression(dictLazy)(m))))(function (rest) {
                  ...
                  if (rest instanceof Data_Maybe.Just) {
                      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(WFF.Binary.create({
                          left: left,
                          operator: rest.value0.operator,
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Json.WFF"] = $PS["Json.WFF"] || {};
  var exports = $PS["Json.WFF"];
  var Data_Argonaut_Core = $PS["Data.Argonaut.Core"];
  var Data_Either = $PS["Data.Either"];
  var Parser = $PS["Parser"];
  var WFF = $PS["WFF"];                
  var toJson = function ($0) {
      return Data_Argonaut_Core.fromString(WFF.render($0));
  };
...
(function($PS) {
  ...
  var Data_String_Common = $PS["Data.String.Common"];
  var Data_Traversable = $PS["Data.Traversable"];
  var Deduction_1 = $PS["Deduction"];                
  var Deduction = (function () {
      function Deduction(value0) {
          this.value0 = value0;
      };
      Deduction.create = function (value0) {
          return new Deduction(value0);
      };
      return Deduction;
  })();
  var Proof = (function () {
      function Proof(value0) {
          this.value0 = value0;
      };
      Proof.create = function (value0) {
          return new Proof(value0);
      };
      return Proof;
  })();
  var renderReason = function (v) {
      return Deduction_1.renderRule(v.value0.rule) + (" " + Data_String_Common.joinWith(",")(Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(Data_Show.showInt))(v.value0.reasons)));
  };
  var pack = function (v) {
      return {
          formula: v.value0.deduction,
          isAssumption: Deduction_1.isAssumption(v.value0.rule),
  ...
  var getNextUnused = function (s) {
      ...
      throw new Error("Failed pattern match at Proof (line 81, column 19 - line 83, column 16): " + [ v.constructor.name ]);
  };
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Invalid line number in reason")(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)((function () {
              ...
              return Control_Bind.bind(Data_Either.bindEither)(Deduction_1.matchDeduction(antes)(v.value0.deduction)(v.value0.rule))(function (assumptions) {
                  ...
                  if (assumptions instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(Data_Set.singleton(getNextUnused(v1.value0.assumptions)));
                  };
                  throw new Error("Failed pattern match at Proof (line 92, column 5 - line 94, column 70): " + [ assumptions.constructor.name ]);
              });
          });
      };
  };
  ...
  var addDeduction = function (v) {
      return function (v1) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Invalid line number in reason")(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)((function () {
              ...
              return Control_Bind.bind(Data_Either.bindEither)(Deduction_1.matchDeduction(antes)(v.value0.deduction)(v.value0.rule))(function (assumptions) {
                  if (assumptions instanceof Data_Maybe.Just && Data_Eq.eq(Data_Set.eqSet(Data_Eq.eqInt))(assumptions.value0)(v.value0.assumptions)) {
                      return Data_Either.Right.create(Proof.create({
                          ...
                          assumptions: v1.value0.assumptions
                      }));
                  };
                  if (assumptions instanceof Data_Maybe.Just) {
                      return new Data_Either.Left("Incorrect assumptions");
                  };
                  if (Data_Set.size(v.value0.assumptions) !== 1) {
                      return new Data_Either.Left("Wrong number of assumptions");
                  };
                  if (Data_Set.subset(Data_Ord.ordInt)(v.value0.assumptions)(v1.value0.assumptions)) {
                      return new Data_Either.Left("Assumption number already in use");
                  };
                  return Data_Either.Right.create(Proof.create({
                      lines: Data_Semigroup.append(Data_Semigroup.semigroupArray)(v1.value0.lines)([ new Deduction(v.value0) ]),
                      assumptions: Data_Set.union(Data_Ord.ordInt)(v1.value0.assumptions)(v.value0.assumptions)
                  }));
              });
          });
      };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Json.Proof"] = $PS["Json.Proof"] || {};
  var exports = $PS["Json.Proof"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Argonaut_Core = $PS["Data.Argonaut.Core"];
  var Data_Array = $PS["Data.Array"];
  ...
  var Data_Unfoldable = $PS["Data.Unfoldable"];
  var Foreign_Object = $PS["Foreign.Object"];
  var Json_Deduction = $PS["Json.Deduction"];
  var Json_WFF = $PS["Json.WFF"];
  var Proof = $PS["Proof"];                
                  ...
                  return function (j) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Deduction is not an object")(Data_Argonaut_Core.toObject(j)))(function (o) {
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Deduction is missing formula")(Foreign_Object.lookup("formula")(o)))(function (formJson) {
                              return Control_Bind.bind(Data_Either.bindEither)(Json_WFF.fromJson(symbolMap)(formJson))(function (deduction) {
                                          ...
                                          return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Deduction is missing references")(Foreign_Object.lookup("references")(o)))(function (refJson) {
                                              return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Deduction references are not a list")(Data_Argonaut_Core.toArray(refJson)))(function (refArr) {
                                                  return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Deduction references are not integers")(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Array.sort(Data_Ord.ordInt))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(Control_Bind.composeKleisli(Data_Maybe.bindMaybe)(Data_Argonaut_Core.toNumber)(Data_Int.fromNumber))(refArr))))(function (reasons) {
                                                      ...
                                                      throw new Error("Failed pattern match at Json.Proof (line 52, column 5 - line 64, column 71): " + [ v1.constructor.name ]);
                                                  });
                                              });
                                          });
                                      });
  ...
  var toJson = function (v) {
      return Data_Argonaut_Core.fromArray(Data_Functor.map(Data_Functor.functorArray)(fromDeduction)(v.value0.lines));
  };
  exports["toJson"] = toJson;
  exports["fromJson"] = fromJson;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Json.Sequent"] = $PS["Json.Sequent"] || {};
  var exports = $PS["Json.Sequent"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Argonaut_Core = $PS["Data.Argonaut.Core"];
  var Data_Either = $PS["Data.Either"];
  ...
  var Sequent = $PS["Sequent"];                
  var toJson = function (v) {
      return Data_Argonaut_Core.fromObject(Foreign_Object.fromFoldable(Data_Foldable.foldableArray)([ Data_Tuple.Tuple.create("ante")(Data_Argonaut_Core.fromArray(Data_Functor.map(Data_Functor.functorArray)(Json_WFF.toJson)(v.value0.ante))), Data_Tuple.Tuple.create("conse")(Json_WFF.toJson(v.value0.conse)) ]));
  };
  var fromObject = function (m) {
      return function (o) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Sequent is missing ante")(Foreign_Object.lookup("ante")(o)))(function (anteJson) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Core.caseJsonArray(new Data_Either.Left("Sequent ante is not a list"))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(Json_WFF.fromJson(m)))(anteJson))(function (ante) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Sequent is missing conse")(Foreign_Object.lookup("conse")(o)))(function (conseJson) {
                      return Control_Bind.bind(Data_Either.bindEither)(Json_WFF.fromJson(m)(conseJson))(function (conse) {
...
(function($PS) {
  ...
  var WFF = $PS["WFF"];                
  var toJson = function (v) {
      if (v instanceof $$Symbol.UnarySymbol) {
          return Data_Argonaut_Core.fromObject(Foreign_Object.fromFoldable(Data_Foldable.foldableArray)([ Data_Tuple.Tuple.create("symbol")(Data_Argonaut_Core.fromString(v.value0.operator.symbol)), Data_Tuple.Tuple.create("prop")(Data_Argonaut_Core.fromString("A")), Data_Tuple.Tuple.create("definition")(Json_WFF.toJson(Data_Functor.voidRight(WFF.functorWFF)("A")(v.value0.definition))) ]));
      };
      if (v instanceof $$Symbol.BinarySymbol) {
          return Data_Argonaut_Core.fromObject(Foreign_Object.fromFoldable(Data_Foldable.foldableArray)([ Data_Tuple.Tuple.create("symbol")(Data_Argonaut_Core.fromString(v.value0.operator.symbol)), Data_Tuple.Tuple.create("propa")(Data_Argonaut_Core.fromString("A")), Data_Tuple.Tuple.create("propb")(Data_Argonaut_Core.fromString("B")), Data_Tuple.Tuple.create("definition")(Json_WFF.toJson(Data_Functor.map(WFF.functorWFF)(function (v1) {
              if (v1) {
                  return "A";
              };
              return "B";
      ...
      throw new Error("Failed pattern match at Json.Symbol (line 21, column 1 - line 21, column 25): " + [ v.constructor.name ]);
  };
                      ...
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Symbol is missing prop")(Foreign_Object.lookup("prop")(v1)))(function (propJson) {
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Core.caseJsonString(new Data_Either.Left("Symbol prop is not a string"))(Data_Either.Right.create)(propJson))(function (prop) {
                              return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Symbol is missing definition")(Foreign_Object.lookup("definition")(v1)))(function (defJson) {
                                  return Control_Bind.bind(Data_Either.bindEither)(Json_WFF.fromJson(v)(defJson))(function (definition) {
  ...
  var addOne = function (s) {
      return function (j) {
          return Control_Bind.bind(Data_Either.bindEither)(fromJson(s.symbolMap)(j))(function (newSym) {
              return Control_Bind.bind(Data_Either.bindEither)($$Symbol.updateMap(s.symbolMap)(newSym))(function (newMap) {
  ...
  var fromJson = function (j) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Json is not an object")(Data_Argonaut_Core.toObject(j)))(function (o) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Json is missing symbols")(Foreign_Object.lookup("symbols")(o)))(function (symJson) {
              return Control_Bind.bind(Data_Either.bindEither)(Json_Symbol.allFromJson(symJson))(function (v) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Json is missing sequents")(Foreign_Object.lookup("sequents")(o)))(function (seqJson) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Either.note("Sequents are not in a list")(Data_Argonaut_Core.toArray(seqJson)))(function (seqArr) {
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(Json_Sequent.fromJson(v.symbolMap))(seqArr))(function (sequents) {
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["UI.Capabilities"] = $PS["UI.Capabilities"] || {};
  var exports = $PS["UI.Capabilities"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Trans_Class = $PS["Control.Monad.Trans.Class"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Parser = $PS["Parser"];                
  var SequentWindow = (function () {
      function SequentWindow() {

      };
      SequentWindow.value = new SequentWindow();
      return SequentWindow;
  })();
  var SymbolWindow = (function () {
      function SymbolWindow() {

      };
      SymbolWindow.value = new SymbolWindow();
      return SymbolWindow;
  })();
  var IEWindow = (function () {
      function IEWindow() {

      };
      IEWindow.value = new IEWindow();
      return IEWindow;
  })();
  var NoWindow = (function () {
      ...
      NoWindow.value = new NoWindow();
      return NoWindow;
  })();
  var WriteSymbols = function (Monad0, addSymbol) {
      this.Monad0 = Monad0;
      this.addSymbol = addSymbol;
  };
  var WriteSequents = function (Monad0, addSequent) {
      this.Monad0 = Monad0;
      this.addSequent = addSequent;
  };
  var WriteProof = function (Monad0, addDeduction) {
      this.Monad0 = Monad0;
      this.addDeduction = addDeduction;
  };
  var ReadSymbols = function (Monad0, getSymbolMap, getSymbols) {
      this.Monad0 = Monad0;
      this.getSymbolMap = getSymbolMap;
      this.getSymbols = getSymbols;
  };
  var ReadSequents = function (Monad0, getSequents) {
      this.Monad0 = Monad0;
      this.getSequents = getSequents;
  };
  var ReadProof = function (Monad0, getProof) {
      this.Monad0 = Monad0;
      this.getProof = getProof;
  };
  var ReadNav = function (Monad0, getWindow) {
      this.Monad0 = Monad0;
      this.getWindow = getWindow;
  };
  var ReadFile = function (Monad0, readFile) {
      this.Monad0 = Monad0;
      this.readFile = readFile;
  };
  var ReadError = function (Monad0, getErrors) {
      this.Monad0 = Monad0;
      this.getErrors = getErrors;
  };
  var Nav = function (Monad0, setWindow) {
      this.Monad0 = Monad0;
  ...
  var $$Error = function (Monad0, clear, errors) {
      this.Monad0 = Monad0;
      this.clear = clear;
      this.errors = errors;
  };
  var undo = function (dict) {
      return dict.undo;
  };
  var setWindow = function (dict) {
      return dict.setWindow;
  };
  var redo = function (dict) {
      return dict.redo;
  };
  var readFile = function (dict) {
      return dict.readFile;
  };
  var readFileHalogenM = function (dictReadFile) {
      return new ReadFile(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, function (f) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictReadFile.Monad0())(readFile(dictReadFile)(f)))(Halogen_Query_HalogenM.raise(Data_Unit.unit));
      });
  };
  var $$new = function (dict) {
      return dict["new"];
  };
  var navHalogenM = function (dictNav) {
      return new Nav(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, function (w) {
  ...
  var readNavHalogenM = function (dictReadNav) {
      return new ReadNav(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictReadNav.Monad0())(getWindow(dictReadNav)));
  };
  var getSymbols = function (dict) {
      return dict.getSymbols;
  };
  var getSymbolMap = function (dict) {
      return dict.getSymbolMap;
  };
  var parse = function (dictReadSymbols) {
      return function (s) {
          return Control_Bind.bind((dictReadSymbols.Monad0()).Bind1())(getSymbolMap(dictReadSymbols))(function (m) {
              return Control_Applicative.pure((dictReadSymbols.Monad0()).Applicative0())(Parser.parse(m)(s));
          });
      };
  };
  var readSymbolsHalogenM = function (dictReadSymbols) {
      return new ReadSymbols(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictReadSymbols.Monad0())(getSymbolMap(dictReadSymbols)), Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictReadSymbols.Monad0())(getSymbols(dictReadSymbols)));
  };
  var getSequents = function (dict) {
      return dict.getSequents;
  };
  var readSequentsHalogenM = function (dictReadSequents) {
      return new ReadSequents(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictReadSequents.Monad0())(getSequents(dictReadSequents)));
  };
  var getProof = function (dict) {
      return dict.getProof;
  };
  var readProofHalogenM = function (dictReadProof) {
      return new ReadProof(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictReadProof.Monad0())(getProof(dictReadProof)));
  };
  var getErrors = function (dict) {
      return dict.getErrors;
  };
  var readErrorHalogenM = function (dictReadError) {
      return new ReadError(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictReadError.Monad0())(getErrors(dictReadError)));
  };
  var errors = function (dict) {
      return dict.errors;
  };
  var error = function (dictError) {
      var $27 = errors(dictError);
      var $28 = Control_Applicative.pure(Control_Applicative.applicativeArray);
      return function ($29) {
          return $27($28($29));
      };
  };
  var eqWindow = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof SequentWindow && y instanceof SequentWindow) {
              return true;
          };
          if (x instanceof SymbolWindow && y instanceof SymbolWindow) {
              return true;
          };
          if (x instanceof IEWindow && y instanceof IEWindow) {
              return true;
          };
          if (x instanceof NoWindow && y instanceof NoWindow) {
              return true;
          };
          return false;
      };
  });
  var isIEWindow = function (dictReadNav) {
      return Data_Functor.map((((dictReadNav.Monad0()).Bind1()).Apply0()).Functor0())(function (v) {
          return Data_Eq.eq(eqWindow)(v)(IEWindow.value);
      })(getWindow(dictReadNav));
  };
  var isSequentWindow = function (dictReadNav) {
      return Data_Functor.map((((dictReadNav.Monad0()).Bind1()).Apply0()).Functor0())(function (v) {
          return Data_Eq.eq(eqWindow)(v)(SequentWindow.value);
      })(getWindow(dictReadNav));
  };
  var isSymbolWindow = function (dictReadNav) {
      return Data_Functor.map((((dictReadNav.Monad0()).Bind1()).Apply0()).Functor0())(function (v) {
          return Data_Eq.eq(eqWindow)(v)(SymbolWindow.value);
      })(getWindow(dictReadNav));
  };
  var close = function (dictNav) {
      return setWindow(dictNav)(NoWindow.value);
  };
  var clear = function (dict) {
      return dict.clear;
  };
  var errorHalogenM = function (dictError) {
      return new $$Error(function () {
          return Halogen_Query_HalogenM.monadHalogenM;
      }, Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictError.Monad0())(clear(dictError)))(Halogen_Query_HalogenM.raise(Data_Unit.unit)), function (e) {
  ...
  var writeSymbolsHalogenM = function (dictWriteSymbols) {
  ...
  var addSequent = function (dict) {
      return dict.addSequent;
  };
  var writeSequentsHalogenM = function (dictWriteSequents) {
  ...
  var addDeduction = function (dict) {
      return dict.addDeduction;
  };
  var writeProofHalogenM = function (dictWriteProof) {
  ...
  exports["SymbolWindow"] = SymbolWindow;
  exports["IEWindow"] = IEWindow;
  exports["NoWindow"] = NoWindow;
  exports["ReadSymbols"] = ReadSymbols;
  exports["getSymbols"] = getSymbols;
  exports["parse"] = parse;
  exports["WriteSymbols"] = WriteSymbols;
  exports["addSymbol"] = addSymbol;
  exports["ReadSequents"] = ReadSequents;
  exports["getSequents"] = getSequents;
  exports["WriteSequents"] = WriteSequents;
  exports["addSequent"] = addSequent;
  ...
  exports["writeSequentsHalogenM"] = writeSequentsHalogenM;
  exports["readProofHalogenM"] = readProofHalogenM;
  exports["writeProofHalogenM"] = writeProofHalogenM;
  exports["errorHalogenM"] = errorHalogenM;
  exports["readErrorHalogenM"] = readErrorHalogenM;
  exports["readNavHalogenM"] = readNavHalogenM;
  exports["navHalogenM"] = navHalogenM;
  exports["historyHalogenM"] = historyHalogenM;
  exports["readFileHalogenM"] = readFileHalogenM;
})(PS);
(function(exports) {
...
})(PS["UI.File"] = PS["UI.File"] || {});
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["UI.File"] = $PS["UI.File"] || {};
  var exports = $PS["UI.File"];
  var $foreign = $PS["UI.File"];
  exports["readFile"] = $foreign.readFile;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var startWith = function (present) {
      return {
          history: [  ],
          future: [  ],
          present: present,
  ...
  var run = function (r) {
      return function (v) {
          return Control_Monad_Reader_Trans.runReaderT(v)(r);
      };
  };
  var monadAppStateM = Control_Monad_Reader_Trans.monadReaderT(Effect.monadEffect);
  var readFileAppStateM = new UI_Capabilities.ReadFile(function () {
      return monadAppStateM;
  }, function (e) {
      return AppStateM(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (ref) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.read(ref)))(function (state) {
              return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Promise.runPromise(function (s) {
                  var v = Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Parser.jsonParser(s))(Json.fromJson);
                  if (v instanceof Data_Either.Left) {
                      return Effect_Ref.modify_(function (v1) {
                          ...
                          $42.error = new Data_Maybe.Just([ "Error loading file: " + v.value0 ]);
                          return $42;
                      })(ref);
                  };
                  if (v instanceof Data_Either.Right) {
                      return Effect_Ref.modify_(function (v1) {
                          ...
                          $46.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)(state.history)([ state.present ]);
                          $46.future = [  ];
                          $46.present = v.value0;
                          $46.error = Data_Maybe.Nothing.value;
                          return $46;
                      })(ref);
                  };
                  throw new Error("Failed pattern match at UI.AppState (line 249, column 20 - line 261, column 24): " + [ v.constructor.name ]);
              })(Data_Function["const"](Effect_Ref.modify_(function (v) {
                  var $50 = {};
                  for (var $51 in v) {
                  ...
                  $50.error = new Data_Maybe.Just([ "Error loading file" ]);
                  return $50;
              })(ref)))(function (dictDeferred) {
                  return UI_File.readFile(e);
              }));
          });
      }));
  });
  var modify = function (f) {
      return AppStateM(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (ref) {
          return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.modify_(f)(ref));
      }));
  };
  var navAppStateM = new UI_Capabilities.Nav(function () {
      return monadAppStateM;
  }, function (window) {
  ...
  var get = AppStateM(Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect.bindEffect))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect.monadEffect)))(function (ref) {
      return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Effect_Ref.read(ref));
  }));
  var functorAppStateM = Control_Monad_Reader_Trans.functorReaderT(Effect.functorEffect);
  var readErrorAppStateM = new UI_Capabilities.ReadError(function () {
      return monadAppStateM;
  }, Data_Functor.map(functorAppStateM)(function (v) {
      return v.error;
  })(get));
  var readNavAppStateM = new UI_Capabilities.ReadNav(function () {
      return monadAppStateM;
  }, Data_Functor.map(functorAppStateM)(function (v) {
      return v.window;
  })(get));
  var readProofAppStateM = new UI_Capabilities.ReadProof(function () {
      return monadAppStateM;
  }, Data_Functor.map(functorAppStateM)(function (v) {
      return v.present.proof;
  })(get));
  var readSequentsAppStateM = new UI_Capabilities.ReadSequents(function () {
      return monadAppStateM;
  }, Data_Functor.map(functorAppStateM)(function (v) {
      return v.present.sequents;
  })(get));
  var readSymbolsAppStateM = new UI_Capabilities.ReadSymbols(function () {
      return monadAppStateM;
  }, Data_Functor.map(functorAppStateM)(function (v) {
      return v.present.symbolMap;
  })(get), Data_Functor.map(functorAppStateM)(function (v) {
      return v.present.symbols;
  })(get));
  var errorAppStateM = new UI_Capabilities["Error"](function () {
      return monadAppStateM;
  }, modify(function (v) {
      return {
          history: v.history,
  ...
  var write = Control_Bind.bind(bindAppStateM)(get)(function (state) {
      var json = Json.toJson(state.present.symbols)(state.present.sequents)(state.present.proof);
      var string = Data_Argonaut_Core.stringify(json);
      return AppStateM(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect.monadEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.localStorage))(Web_Storage_Storage.setItem("proof")(string))));
  });
  var writeProofAppStateM = new UI_Capabilities.WriteProof(function () {
      ...
      var validate = function (s) {
          ...
          throw new Error("Failed pattern match at UI.AppState (line 169, column 26 - line 179, column 34): " + [ v1.constructor.name ]);
      };
  ...
  var writeSymbolsAppStateM = new UI_Capabilities.WriteSymbols(function () {
      ...
      return Control_Bind.bind(bindAppStateM)(get)(function (state) {
          ...
          throw new Error("Failed pattern match at UI.AppState (line 126, column 9 - line 138, column 30): " + [ v.constructor.name ]);
      });
  });                                                                              
  ...
  var historyAppStateM = new UI_Capabilities.History(function () {
      ...
      return Control_Bind.bind(bindAppStateM)(UI_Capabilities.canNew(historyAppStateM))(function (ableNew) {
          return Control_Applicative.when(applicativeAppStateM)(ableNew)(Control_Bind.discard(Control_Bind.discardUnit)(bindAppStateM)(modify(function (v) {
              return {
                  history: Data_Semigroup.append(Data_Semigroup.semigroupArray)(state.history)([ state.present ]),
                  future: [  ],
                  present: {
      ...
      if (v instanceof Data_Maybe.Nothing) {
          return Control_Applicative.pure(applicativeAppStateM)(Data_Unit.unit);
      };
      if (v instanceof Data_Maybe.Just) {
          return Control_Bind.discard(Control_Bind.discardUnit)(bindAppStateM)(modify(function (v1) {
              return {
                  history: Data_Semigroup.append(Data_Semigroup.semigroupArray)(state.history)([ state.present ]),
                  future: v.value0.tail,
                  present: v.value0.head,
                  error: Data_Maybe.Nothing.value,
                  window: v1.window
              };
          }))(function () {
      ...
      throw new Error("Failed pattern match at UI.AppState (line 205, column 30 - line 214, column 18): " + [ v.constructor.name ]);
  }), Control_Bind.bind(bindAppStateM)(get)(function (state) {
      ...
      if (v instanceof Data_Maybe.Just) {
          return Control_Bind.discard(Control_Bind.discardUnit)(bindAppStateM)(modify(function (v1) {
              return {
                  history: v.value0.init,
                  future: Data_Semigroup.append(Data_Semigroup.semigroupArray)([ state.present ])(state.future),
                  present: v.value0.last,
                  error: Data_Maybe.Nothing.value,
                  window: v1.window
              };
          }))(function () {
      ...
      throw new Error("Failed pattern match at UI.AppState (line 195, column 30 - line 204, column 18): " + [ v.constructor.name ]);
  }));
  exports["run"] = run;
  exports["start"] = start;
  exports["startWith"] = startWith;
  exports["startWithErr"] = startWithErr;
  exports["readSymbolsAppStateM"] = readSymbolsAppStateM;
  exports["writeSymbolsAppStateM"] = writeSymbolsAppStateM;
  exports["readSequentsAppStateM"] = readSequentsAppStateM;
  exports["writeSequentsAppStateM"] = writeSequentsAppStateM;
  exports["readProofAppStateM"] = readProofAppStateM;
  exports["writeProofAppStateM"] = writeProofAppStateM;
  exports["errorAppStateM"] = errorAppStateM;
  exports["readErrorAppStateM"] = readErrorAppStateM;
  exports["readNavAppStateM"] = readNavAppStateM;
  exports["navAppStateM"] = navAppStateM;
  exports["historyAppStateM"] = historyAppStateM;
  exports["readFileAppStateM"] = readFileAppStateM;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["UI.ImEx"] = $PS["UI.ImEx"] || {};
  var exports = $PS["UI.ImEx"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var DOM_HTML_Indexed_InputAcceptType = $PS["DOM.HTML.Indexed.InputAcceptType"];
      ...
      return function (dictReadFile) {
          return function (v) {
              if (v instanceof Close) {
                  return UI_Capabilities.close(UI_Capabilities.navHalogenM(dictNav));
              };
              if (v instanceof Load) {
                  return UI_Capabilities.readFile(UI_Capabilities.readFileHalogenM(dictReadFile))(v.value0);
              };
...
(function($PS) {
  ...
  var $$Symbol = $PS["Symbol"];
  var UI_Capabilities = $PS["UI.Capabilities"];
  var UI_HTMLHelp = $PS["UI.HTMLHelp"];
  var WFF = $PS["WFF"];                
  var Update = (function () {
      function Update(value0) {
          this.value0 = value0;
  ...
  var PartSymbol = (function () {
      function PartSymbol() {

      };
      PartSymbol.value = new PartSymbol();
      return PartSymbol;
  })();
  var PartSequent = (function () {
      function PartSequent() {

      };
      PartSequent.value = new PartSequent();
      return PartSequent;
  })();
  var Assumptions = (function () {
      function Assumptions(value0) {
          this.value0 = value0;
      };
      Assumptions.create = function (value0) {
          return new Assumptions(value0);
      };
      return Assumptions;
  })();
  var Formula = (function () {
      function Formula(value0) {
          this.value0 = value0;
      };
      Formula.create = function (value0) {
          return new Formula(value0);
      };
      return Formula;
  })();
  var Reason = (function () {
      function Reason(value0) {
          this.value0 = value0;
      };
      Reason.create = function (value0) {
          return new Reason(value0);
      };
      return Reason;
  })();
  var References = (function () {
      function References(value0) {
          this.value0 = value0;
      };
      References.create = function (value0) {
          return new References(value0);
      };
      return References;
  })();
  ...
  var toDeduction = function (v) {
      if (v instanceof Full) {
          return new Data_Either.Right(v.value0);
      };
      if (v instanceof PartSymbol) {
          return new Data_Either.Left("Select a symbol or other reason");
      };
  ...
  var renderDeduction = function (i) {
      return function (v) {
          return Halogen_HTML_Elements.tr([  ])([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("assumptions") ])([ Halogen_HTML_Core.text(Data_String_Common.joinWith(",")(Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(Data_Show.showInt))(Data_Set.toUnfoldable(Data_Unfoldable.unfoldableArray)(v.value0.assumptions)))) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("line-number") ])([ Halogen_HTML_Core.text("(" + (Data_Show.show(Data_Show.showInt)(i + 1 | 0) + ")")) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("formula") ])([ Halogen_HTML_Core.text(WFF.render(v.value0.deduction)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("reason") ])([ Halogen_HTML_Core.text(Proof.renderReason(new Proof.Deduction(v.value0))) ]) ]);
      };
  };
  var makePartial = function (v) {
      if (v instanceof Full && v.value0 instanceof Deduction.Definition) {
          return PartSymbol.value;
      };
      if (v instanceof Full && v.value0 instanceof Deduction.Introduction) {
          return PartSequent.value;
      };
      return v;
  };
  var lineHeading = Halogen_HTML_Elements.tr([  ])([ Halogen_HTML_Elements.th([ Halogen_HTML_Properties.class_("assumptions") ])([ Halogen_HTML_Core.text("Assumptions") ]), Halogen_HTML_Elements.th([ Halogen_HTML_Properties.class_("line-number") ])([ Halogen_HTML_Core.text("Line No.") ]), Halogen_HTML_Elements.th([ Halogen_HTML_Properties.class_("formula") ])([ Halogen_HTML_Core.text("Formula") ]), Halogen_HTML_Elements.th([ Halogen_HTML_Properties.class_("reason") ])([ Halogen_HTML_Core.text("Reason") ]) ]);
  var initialState = {
      symbols: [  ],
      sequents: [  ],
      proof: Proof.empty,
      assumptions: "",
      formula: "",
      reason: new Full(Deduction.Assumption.value),
      references: ""
  };
  var handleQuery = function (dictReadSymbols) {
  ...
  var eqPartialDeduction = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Full && y instanceof Full) {
              return Data_Eq.eq(Deduction.eqDeductionRule)(x.value0)(y.value0);
          };
          if (x instanceof PartSymbol && y instanceof PartSymbol) {
              return true;
          };
  ...
  var ordPartialDeduction = new Data_Ord.Ord(function () {
      return eqPartialDeduction;
  }, function (x) {
      return function (y) {
          if (x instanceof Full && y instanceof Full) {
              return Data_Ord.compare(Deduction.ordDeductionRule)(x.value0)(y.value0);
          };
          ...
          if (x instanceof PartSymbol) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof PartSymbol) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof PartSequent && y instanceof PartSequent) {
              return Data_Ordering.EQ.value;
  ...
  var renderNewLine = function (state) {
      return Halogen_HTML_Elements.tr([ Halogen_HTML_Properties.id_("new-line") ])([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("assumptions") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueChange(function ($110) {
          return Data_Maybe.Just.create(Assumptions.create($110));
      }), Halogen_HTML_Properties.value(state.assumptions), Halogen_HTML_Properties.id_("assumptions-input") ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("line-number") ])([ Halogen_HTML_Core.text("(" + (Data_Show.show(Data_Show.showInt)(Data_Foldable.length(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(state.proof.value0.lines) + 1 | 0) + ")")) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("formula") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueChange(function ($111) {
          return Data_Maybe.Just.create(Formula.create($111));
      }), Halogen_HTML_Properties.id_("formula-input"), Halogen_HTML_Properties.value(state.formula) ]) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("reason") ])([ UI_HTMLHelp.select(ordPartialDeduction)("reason-dropdown")(function ($112) {
          return Data_Maybe.Just.create(Reason.create($112));
          ...
          if (state.reason instanceof PartSymbol) {
              return UI_HTMLHelp.select(ordPartialDeduction)("symbol-dropdown")(function ($113) {
                  return Data_Maybe.Just.create(Reason.create($113));
          ...
          if (state.reason instanceof Full && state.reason.value0 instanceof Deduction.Definition) {
              return UI_HTMLHelp.select(ordPartialDeduction)("symbol-dropdown")(function ($114) {
                  return Data_Maybe.Just.create(Reason.create($114));
          ...
          if (state.reason instanceof PartSequent) {
              return UI_HTMLHelp.select(ordPartialDeduction)("sequent-dropdown")(function ($115) {
                  return Data_Maybe.Just.create(Reason.create($115));
          ...
          if (state.reason instanceof Full && state.reason.value0 instanceof Deduction.Introduction) {
              return UI_HTMLHelp.select(ordPartialDeduction)("sequent-dropdown")(function ($116) {
                  return Data_Maybe.Just.create(Reason.create($116));
              })(Data_Function["const"](false))(new Full(state.reason.value0))(Data_Array.mapWithIndex(function (i) {
                  return function (seq) {
                      return Data_Tuple.Tuple.create(Sequent.render(seq))(Full.create(new Deduction.Introduction(seq, i)));
                  };
      ...
      })() ]), Halogen_HTML_Elements.input(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Events.onValueChange(function ($117) {
          return Data_Maybe.Just.create(References.create($117));
  ...
  var handleAction = function (dictReadSymbols) {
      return function (dictWriteProof) {
                              ...
                              if (v1 instanceof Data_Either.Right) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(UI_Capabilities.addDeduction(UI_Capabilities.writeProofHalogenM(dictWriteProof))(v1.value0))(function (success) {
                                      return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(success)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                          ...
                                          $106.assumptions = "";
                                          $106.formula = "";
                                          $106.reason = new Full(Deduction.Assumption.value);
                                          $106.references = "";
                                          return $106;
                                      }));
                                  });
  ...
  var component = function (dictReadSymbols) {
      return function (dictReadSequents) {
          return function (dictReadProof) {
              return function (dictWriteProof) {
                  return function (dictError) {
                      return Halogen_Component.mkComponent({
                          ...
                          render: render,
                          "eval": Halogen_Component.mkEval({
                              handleAction: handleAction(dictReadSymbols)(dictWriteProof)(dictError),
                              handleQuery: handleQuery(dictReadSymbols)(dictReadSequents)(dictReadProof),
                              receive: Halogen_Component.defaultEval.receive,
                              initialize: Halogen_Component.defaultEval.initialize,
                              finalize: Halogen_Component.defaultEval.finalize
                          })
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["UI.Sequent"] = $PS["UI.Sequent"] || {};
  var exports = $PS["UI.Sequent"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Array = $PS["Data.Array"];
  ...
  var Ante = (function () {
      function Ante(value0) {
          this.value0 = value0;
      };
      Ante.create = function (value0) {
          return new Ante(value0);
      };
      return Ante;
  })();
  var Conse = (function () {
      function Conse(value0) {
          this.value0 = value0;
      };
      Conse.create = function (value0) {
          return new Conse(value0);
      };
      return Conse;
  })();
  var Add = (function () {
  ...
  var render = function (state) {
      if (state.open) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("floating"), Halogen_HTML_Properties.id_("sequent-box") ])([ Halogen_HTML_Elements.table([ Halogen_HTML_Properties.id_("sequent-list") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(renderSequent)(state.sequents))([ renderNewSeq(state) ])), Halogen_HTML_Elements.div([ Halogen_HTML_Events.onClick(Data_Function["const"](new Data_Maybe.Just(Add.value))), Halogen_HTML_Properties.id_("add-sequent"), Halogen_HTML_Properties.class_("button") ])([ Halogen_HTML_Core.text("Add Sequent") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Events.onClick(Data_Function["const"](new Data_Maybe.Just(Close.value))), Halogen_HTML_Properties.id_("close-button"), Halogen_HTML_Properties.class_("button") ])([ Halogen_HTML_Core.text("Close") ]) ]);
      };
      if (Data_Boolean.otherwise) {
          return Halogen_HTML_Elements.div([  ])([  ]);
      };
  ...
  var handleQuery = function (dictReadSequents) {
      return function (dictReadNav) {
          return function (v) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(UI_Capabilities.getSequents(UI_Capabilities.readSequentsHalogenM(dictReadSequents)))(function (sequents) {
  ...
  var handleAction = function (dictReadSymbols) {
      return function (dictWriteSequents) {
          return function (dictError) {
                  ...
                  return function (dictReadSequents) {
                      return function (dictReadNav) {
                          return Halogen_Component.mkComponent({
                              ...
                              render: render,
                              "eval": Halogen_Component.mkEval({
                                  handleAction: handleAction(dictReadSymbols)(dictWriteSequents)(dictError)(dictNav),
                                  handleQuery: handleQuery(dictReadSequents)(dictReadNav),
                                  receive: Halogen_Component.defaultEval.receive,
                                  initialize: Halogen_Component.defaultEval.initialize,
                                  finalize: Halogen_Component.defaultEval.finalize
                              })
...
(function($PS) {
  ...
  var symbolRow = function (v) {
      if (v instanceof $$Symbol.UnarySymbol) {
          return Halogen_HTML_Elements.tr([  ])([ Halogen_HTML_Elements.td([  ])([  ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("symbol-name") ])([ Halogen_HTML_Core.text(v.value0.operator.symbol + "A") ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("equiv-symbol") ])([ Halogen_HTML_Core.text(" \u2261 ") ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("symbol-def") ])([ Halogen_HTML_Core.text(WFF.render(Data_Functor.voidRight(WFF.functorWFF)("A")(v.value0.definition))) ]) ]);
      };
      if (v instanceof $$Symbol.BinarySymbol) {
          return Halogen_HTML_Elements.tr([  ])([ Halogen_HTML_Elements.td([  ])([  ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("symbol-name") ])([ Halogen_HTML_Core.text("A" + (v.value0.operator.symbol + "B")) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("equiv-symbol") ])([ Halogen_HTML_Core.text(" \u2261 ") ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("symbol-def") ])([ Halogen_HTML_Core.text(WFF.render(Data_Functor.map(WFF.functorWFF)(function (v1) {
              if (v1) {
                  return "A";
              };
              return "B";
  ...
  var newSymbolRow = function (state) {
      return Halogen_HTML_Elements.tr([ Halogen_HTML_Properties.id_("new-symbol") ])([ Halogen_HTML_Elements.td([  ])([ UI_HTMLHelp.select(Data_Ord.ordBoolean)("operator-select")(function ($54) {
          ...
          return "";
      })()), Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueChange(function ($55) {
          return Data_Maybe.Just.create(Name.create($55));
      }), Halogen_HTML_Properties.value(state.name), Halogen_HTML_Properties.id_("choose-name") ]), Halogen_HTML_Core.text((function () {
          if (state.binary) {
              return "B";
          };
          return "A";
      })()) ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("equiv-symbol") ])([ Halogen_HTML_Core.text(" \u2261 ") ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_("symbol-def") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Events.onValueChange(function ($56) {
          return Data_Maybe.Just.create(Def.create($56));
      }), Halogen_HTML_Properties.value(state.definition), Halogen_HTML_Properties.id_("set-def") ]) ]) ]);
  };
  var render = function (state) {
      if (state.open) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("floating"), Halogen_HTML_Properties.id_("symbol-box") ])([ Halogen_HTML_Elements.table([ Halogen_HTML_Properties.id_("symbol-list") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(symbolRow)(state.symbols))([ newSymbolRow(state) ])), Halogen_HTML_Elements.div([ Halogen_HTML_Events.onClick(Data_Function["const"](new Data_Maybe.Just(Add.value))), Halogen_HTML_Properties.id_("add-symbol"), Halogen_HTML_Properties.class_("button") ])([ Halogen_HTML_Core.text("Add Symbol") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Events.onClick(Data_Function["const"](new Data_Maybe.Just(Close.value))), Halogen_HTML_Properties.id_("close-button"), Halogen_HTML_Properties.class_("button") ])([ Halogen_HTML_Core.text("Close") ]) ]);
      };
      if (Data_Boolean.otherwise) {
          return Halogen_HTML_Elements.div([  ])([  ]);
      };
  ...
  var handleAction = function (dictReadSymbols) {
      return function (dictWriteSymbols) {
          return function (dictNav) {
              return function (dictError) {
                  return function (v) {
                      ...
                      if (v instanceof Add) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(UI_Capabilities.parse(UI_Capabilities.readSymbolsHalogenM(dictReadSymbols))(state.definition))(function (defp) {
                                  var v1 = Control_Bind.bind(Data_Either.bindEither)(Parser.parseSymbol(state.name))(function (name) {
                                      return Control_Bind.bind(Data_Either.bindEither)(defp)(function (def) {
                                          if (state.binary) {
                                              return $$Symbol.makeBinary(Data_Eq.eqString)("A")("B")(name)(def);
                                          };
                                          return $$Symbol.makeUnary(Data_Eq.eqString)("A")(name)(def);
                                      });
                                  });
                                  if (v1 instanceof Data_Either.Left) {
                                      return UI_Capabilities.error(UI_Capabilities.errorHalogenM(dictError))(v1.value0);
              ...
              return function (dictError) {
                  return function (dictReadNav) {
                      return Halogen_Component.mkComponent({
                          ...
                          render: render,
                          "eval": Halogen_Component.mkEval({
                              handleAction: handleAction(dictReadSymbols)(dictWriteSymbols)(dictNav)(dictError),
                              handleQuery: handleQuery(dictReadSymbols)(dictReadNav),
                              receive: Halogen_Component.defaultEval.receive,
                              initialize: Halogen_Component.defaultEval.initialize,
                              finalize: Halogen_Component.defaultEval.finalize
                          })
...
(function($PS) {
  ...
  var Json = $PS["Json"];
  var UI_AppState = $PS["UI.AppState"];
  var UI_Capabilities = $PS["UI.Capabilities"];
  var UI_ImEx = $PS["UI.ImEx"];
  var UI_Proof = $PS["UI.Proof"];
  var UI_Sequent = $PS["UI.Sequent"];
  var UI_Symbol = $PS["UI.Symbol"];
  var Web_HTML = $PS["Web.HTML"];
  var Web_HTML_Window = $PS["Web.HTML.Window"];
  var Web_Storage_Storage = $PS["Web.Storage.Storage"];                
  var Update = (function () {
  ...
  var menu = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("menu") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName((function () {
          ...
          var $22 = Data_Eq.eq(UI_Capabilities.eqWindow)(state.window)(UI_Capabilities.SymbolWindow.value);
          if ($22) {
          ...
          var $23 = Data_Eq.eq(UI_Capabilities.eqWindow)(state.window)(UI_Capabilities.SequentWindow.value);
          if ($23) {
              return UI_Capabilities.NoWindow.value;
          };
          ...
          var $24 = Data_Eq.eq(UI_Capabilities.eqWindow)(state.window)(UI_Capabilities.IEWindow.value);
          if ($24) {
              return UI_Capabilities.NoWindow.value;
          };
  ...
  var _imex = Data_Symbol.SProxy.value;
  var handleAction = function (dictError) {
              ...
              return function (dictHistory) {
                  return function (dictReadNav) {
                      return function (v) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                                          ...
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                                              return "imex";
                                          }))(Data_Ord.ordUnit)(_imex)(Data_Unit.unit)(new UI_ImEx.Update(Data_Unit.unit)))(function () {
                          ...
                          throw new Error("Failed pattern match at UI (line 183, column 1 - line 189, column 56): " + [ v.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var render = function (dictReadSymbols) {
      return function (dictWriteSymbols) {
          return function (dictReadSequents) {
              return function (dictWriteSequents) {
                  return function (dictReadProof) {
                                      ...
                                      return function (dictReadFile) {
                                          return function (state) {
                                              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("main") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ menu(state), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                                                  ...
                                                  throw new Error("Failed pattern match at UI (line 173, column 10 - line 181, column 14): " + [ state.errors.constructor.name ]);
                                              })()));
                                          };
                                      };
                                  };
  ...
  var component = Halogen_Component.mkComponent({
      initialState: Data_Function["const"](initialState),
      render: render(UI_AppState.readSymbolsAppStateM)(UI_AppState.writeSymbolsAppStateM)(UI_AppState.readSequentsAppStateM)(UI_AppState.writeSequentsAppStateM)(UI_AppState.readProofAppStateM)(UI_AppState.writeProofAppStateM)(UI_AppState.errorAppStateM)(UI_AppState.readNavAppStateM)(UI_AppState.navAppStateM)(UI_AppState.readFileAppStateM),
      "eval": Halogen_Component.mkEval({
          ...
          receive: Halogen_Component.defaultEval.receive,
          initialize: new Data_Maybe.Just(Update.value),
          finalize: Halogen_Component.defaultEval.finalize
      })
  });
  var run = function __do() {
      var pf = Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.localStorage))(Web_Storage_Storage.getItem("proof"))();
      var start = (function () {
          if (pf instanceof Data_Maybe.Nothing) {
              return UI_AppState.start;
          };
          if (pf instanceof Data_Maybe.Just) {
              var v = Data_Argonaut_Parser.jsonParser(pf.value0);
              if (v instanceof Data_Either.Left) {
                  return UI_AppState.startWithErr("Error loading from previous session: " + v.value0);
              };
              if (v instanceof Data_Either.Right) {
                  var v1 = Json.fromJson(v.value0);
                  if (v1 instanceof Data_Either.Left) {
                      return UI_AppState.startWithErr("Error loading from previous session: " + v1.value0);
                  };
                  if (v1 instanceof Data_Either.Right) {
                      return UI_AppState.startWith(v1.value0);
                  };
                  throw new Error("Failed pattern match at UI (line 216, column 28 - line 219, column 45): " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at UI (line 213, column 28 - line 219, column 45): " + [ v.constructor.name ]);
          };
          throw new Error("Failed pattern match at UI (line 211, column 17 - line 219, column 45): " + [ pf.constructor.name ]);
      })();
      var ref = Effect_Ref["new"](start)();
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_VDom_Driver.runUI(Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)((function () {
          var $37 = Effect_Class.liftEffect(Effect_Aff.monadEffectAff);
          var $38 = UI_AppState.run(ref);
          return function ($39) {
              return $37($38($39));
          };
      })())(component))(NoAction.value)))();
  };
  exports["run"] = run;
})(PS);
(function($PS) {
