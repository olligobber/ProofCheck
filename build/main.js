...
var _olligobber$proofcheck$DictMerge$mergeErr = F2(
	function (a, b) {
		return A6(
			...
			F3(
				function (k, v, d) {
					return A2(
						_elm_lang$core$Maybe$map,
						A2(_elm_lang$core$Dict$insert, k, v),
						d);
				}),
			F4(
				function (k, v1, v2, d) {
					var _p0 = _elm_lang$core$Native_Utils.eq(v1, v2);
					if (_p0 === true) {
						return A2(
							_elm_lang$core$Maybe$map,
							A2(_elm_lang$core$Dict$insert, k, v1),
							d);
					} else {
						return _elm_lang$core$Maybe$Nothing;
					}
...
var _olligobber$proofcheck$DictMerge$mergeDef = F2(
	function (a, b) {
		var _p1 = {ctor: '_Tuple2', _0: a, _1: b};
		if (((_p1.ctor === '_Tuple2') && (_p1._0.ctor === 'Just')) && (_p1._1.ctor === 'Just')) {
			return A2(_olligobber$proofcheck$DictMerge$mergeErr, _p1._0._0, _p1._1._0);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});

var _olligobber$proofcheck$WFF$match = F2(
	function (small, big) {
		match:
		while (true) {
			var _p0 = {ctor: '_Tuple2', _0: small, _1: big};
			_v0_3:
			do {
				if (_p0.ctor === '_Tuple2') {
					switch (_p0._0.ctor) {
						case 'Binary':
							if (_p0._1.ctor === 'Binary') {
								var _p3 = _p0._0._0;
								var _p2 = _p0._1._0;
								if (_elm_lang$core$Native_Utils.eq(_p3.symbol, _p2.symbol) && _elm_lang$core$Native_Utils.eq(_p3.fn, _p2.fn)) {
									var _p1 = {
										ctor: '_Tuple2',
										_0: A2(_olligobber$proofcheck$WFF$match, _p3.first, _p2.first),
										_1: A2(_olligobber$proofcheck$WFF$match, _p3.second, _p2.second)
									};
									if (((_p1.ctor === '_Tuple2') && (_p1._0.ctor === 'Just')) && (_p1._1.ctor === 'Just')) {
										return A2(_olligobber$proofcheck$DictMerge$mergeErr, _p1._0._0, _p1._1._0);
									} else {
						...
						case 'Unary':
							if (_p0._1.ctor === 'Unary') {
								var _p5 = _p0._0._0;
								var _p4 = _p0._1._0;
								if (_elm_lang$core$Native_Utils.eq(_p5.symbol, _p4.symbol) && _elm_lang$core$Native_Utils.eq(_p5.fn, _p4.fn)) {
									var _v2 = _p5.contents,
										_v3 = _p4.contents;
									small = _v2;
									big = _v3;
									continue match;
						...
						default:
							return _elm_lang$core$Maybe$Just(
								A2(_elm_lang$core$Dict$singleton, _p0._0._0, big));
					}
				} else {
					break _v0_3;
				}
...
var _olligobber$proofcheck$WFF$variables = function (wff) {
	variables:
	while (true) {
		var _p6 = wff;
		switch (_p6.ctor) {
			case 'Prop':
				return _elm_lang$core$Set$singleton(_p6._0);
			case 'Unary':
				var _v5 = _p6._0.contents;
				wff = _v5;
				continue variables;
			default:
				var _p7 = _p6._0;
				return A2(
					...
					_olligobber$proofcheck$WFF$variables(_p7.first),
					_olligobber$proofcheck$WFF$variables(_p7.second));
		}
	}
};
var _olligobber$proofcheck$WFF$fromUn = function (f) {
	var _p8 = {
		ctor: '_Tuple2',
		_0: f(false),
		_1: f(true)
...
var _olligobber$proofcheck$WFF$fromBin = function (f) {
	return _olligobber$proofcheck$WFF$fromUn(
		f(false)) + (4 * _olligobber$proofcheck$WFF$fromUn(
		f(true)));
};
var _olligobber$proofcheck$WFF$toUn = function (n) {
	var _p9 = A2(_elm_lang$core$Basics_ops['%'], n, 4);
	switch (_p9) {
		case 0:
...
var _olligobber$proofcheck$WFF$toBin = F2(
	function (n, a) {
		var _p10 = a;
		if (_p10 === true) {
			return _olligobber$proofcheck$WFF$toUn((n / 4) | 0);
		} else {
			return _olligobber$proofcheck$WFF$toUn(
				A2(_elm_lang$core$Basics_ops['%'], n, 4));
		}
	});
var _olligobber$proofcheck$WFF$eval = F2(
	function (mapping, wff) {
		var _p11 = wff;
		switch (_p11.ctor) {
			case 'Prop':
				return mapping(_p11._0);
			case 'Unary':
				var _p12 = _p11._0;
				return A2(
					_olligobber$proofcheck$WFF$toUn,
					_p12.fn,
					A2(_olligobber$proofcheck$WFF$eval, mapping, _p12.contents));
			default:
				var _p13 = _p11._0;
				return A3(
					_olligobber$proofcheck$WFF$toBin,
					_p13.fn,
					A2(_olligobber$proofcheck$WFF$eval, mapping, _p13.first),
					A2(_olligobber$proofcheck$WFF$eval, mapping, _p13.second));
		}
	});
var _olligobber$proofcheck$WFF$show = function (wff) {
	var _p14 = wff;
	switch (_p14.ctor) {
		case 'Prop':
			return _p14._0;
		case 'Unary':
			...
			return A2(
				_elm_lang$core$Basics_ops['++'],
				_p15.symbol,
				_olligobber$proofcheck$WFF$safeShow(_p15.contents));
		default:
			var _p16 = _p14._0;
			return A2(
				_elm_lang$core$Basics_ops['++'],
				_olligobber$proofcheck$WFF$safeShow(_p16.first),
				A2(
					_elm_lang$core$Basics_ops['++'],
					_p16.symbol,
					_olligobber$proofcheck$WFF$safeShow(_p16.second)));
	}
};
var _olligobber$proofcheck$WFF$safeShow = function (wff) {
	var _p17 = wff;
	if (_p17.ctor === 'Prop') {
		return _p17._0;
	} else {
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_olligobber$proofcheck$WFF$show(_p17),
				')'));
	}
};
var _olligobber$proofcheck$WFF$Binary = function (a) {
	return {ctor: 'Binary', _0: a};
};
var _olligobber$proofcheck$WFF$and = F2(
	function (a, b) {
		return _olligobber$proofcheck$WFF$Binary(
			{
				fn: _olligobber$proofcheck$WFF$fromBin(
					F2(
						function (x, y) {
							return x && y;
						})),
...
var _olligobber$proofcheck$WFF$or = F2(
	function (a, b) {
		return _olligobber$proofcheck$WFF$Binary(
			{
				fn: _olligobber$proofcheck$WFF$fromBin(
...
var _olligobber$proofcheck$WFF$implies = F2(
	function (a, b) {
		return _olligobber$proofcheck$WFF$Binary(
			{
				fn: _olligobber$proofcheck$WFF$fromBin(
...
var _olligobber$proofcheck$WFF$Unary = function (a) {
	return {ctor: 'Unary', _0: a};
};
var _olligobber$proofcheck$WFF$neg = function (v) {
	return _olligobber$proofcheck$WFF$Unary(
		{
			fn: _olligobber$proofcheck$WFF$fromUn(_elm_lang$core$Basics$not),
			symbol: '~',
			contents: v
		});
};
var _olligobber$proofcheck$WFF$Prop = function (a) {
	return {ctor: 'Prop', _0: a};
};
var _olligobber$proofcheck$WFF$substitute = F2(
	function (func, wff) {
		var _p19 = wff;
		switch (_p19.ctor) {
			case 'Prop':
				...
				if (_p20.ctor === 'Nothing') {
					return _olligobber$proofcheck$WFF$Prop(_p21);
				} else {
					return _p20._0;
				}
			case 'Unary':
				...
				return _olligobber$proofcheck$WFF$Unary(
					_elm_lang$core$Native_Utils.update(
						_p22,
						{
							contents: A2(_olligobber$proofcheck$WFF$substitute, func, _p22.contents)
						}));
			default:
				var _p23 = _p19._0;
				return _olligobber$proofcheck$WFF$Binary(
					_elm_lang$core$Native_Utils.update(
						_p23,
						{
							first: A2(_olligobber$proofcheck$WFF$substitute, func, _p23.first),
							second: A2(_olligobber$proofcheck$WFF$substitute, func, _p23.second)
						}));
		}
	});

var _olligobber$proofcheck$Sequent$oe = {
	ante: {
		ctor: '::',
		_0: A2(
			_olligobber$proofcheck$WFF$or,
			_olligobber$proofcheck$WFF$Prop('A'),
			_olligobber$proofcheck$WFF$Prop('B')),
		_1: {
			ctor: '::',
			_0: _olligobber$proofcheck$WFF$Prop('A'),
			_1: {
				ctor: '::',
				_0: _olligobber$proofcheck$WFF$Prop('B'),
				_1: {
					ctor: '::',
					_0: _olligobber$proofcheck$WFF$Prop('C'),
					_1: {
						ctor: '::',
						_0: _olligobber$proofcheck$WFF$Prop('C'),
						_1: {ctor: '[]'}
	...
	conse: _olligobber$proofcheck$WFF$Prop('C')
};
var _olligobber$proofcheck$Sequent$raa = {
	ante: {
		ctor: '::',
		_0: _olligobber$proofcheck$WFF$Prop('A'),
		_1: {
			ctor: '::',
			_0: A2(
				_olligobber$proofcheck$WFF$and,
				_olligobber$proofcheck$WFF$Prop('B'),
				_olligobber$proofcheck$WFF$neg(
					_olligobber$proofcheck$WFF$Prop('B'))),
			_1: {ctor: '[]'}
		}
	},
	conse: _olligobber$proofcheck$WFF$neg(
		_olligobber$proofcheck$WFF$Prop('A'))
};
var _olligobber$proofcheck$Sequent$cp = {
	ante: {
		ctor: '::',
		_0: _olligobber$proofcheck$WFF$Prop('A'),
		_1: {
	...
	conse: A2(
		_olligobber$proofcheck$WFF$implies,
		_olligobber$proofcheck$WFF$Prop('A'),
		_olligobber$proofcheck$WFF$Prop('B'))
};
var _olligobber$proofcheck$Sequent$ass = {
	ante: {ctor: '[]'},
	conse: _olligobber$proofcheck$WFF$Prop('A')
};
var _olligobber$proofcheck$Sequent$oi2 = {
	ante: {
		ctor: '::',
		_0: _olligobber$proofcheck$WFF$Prop('B'),
		_1: {ctor: '[]'}
...
var _olligobber$proofcheck$Sequent$oi1 = {
	ante: {
		ctor: '::',
		_0: _olligobber$proofcheck$WFF$Prop('A'),
		_1: {ctor: '[]'}
...
var _olligobber$proofcheck$Sequent$ae2 = {
	ante: {
		ctor: '::',
		_0: A2(
			_olligobber$proofcheck$WFF$and,
	...
	conse: _olligobber$proofcheck$WFF$Prop('B')
};
var _olligobber$proofcheck$Sequent$ae1 = {
	ante: {
		ctor: '::',
		_0: A2(
			_olligobber$proofcheck$WFF$and,
...
var _olligobber$proofcheck$Sequent$ai = {
	ante: {
		ctor: '::',
		_0: _olligobber$proofcheck$WFF$Prop('A'),
		_1: {
...
var _olligobber$proofcheck$Sequent$mt = {
	ante: {
		ctor: '::',
		_0: _olligobber$proofcheck$WFF$neg(
			_olligobber$proofcheck$WFF$Prop('B')),
		_1: {
			ctor: '::',
			_0: A2(
...
var _olligobber$proofcheck$Sequent$mp = {
	ante: {
		ctor: '::',
		_0: _olligobber$proofcheck$WFF$Prop('A'),
		_1: {
...
var _olligobber$proofcheck$Sequent$dn2 = {
	ante: {
		ctor: '::',
		_0: _olligobber$proofcheck$WFF$Prop('A'),
		_1: {ctor: '[]'}
...
var _olligobber$proofcheck$Sequent$dn1 = {
	ante: {
		ctor: '::',
		_0: _olligobber$proofcheck$WFF$neg(
			_olligobber$proofcheck$WFF$neg(
...
var _olligobber$proofcheck$Sequent$getAny = function (list) {
	getAny:
	while (true) {
		var _p0 = list;
		if (_p0.ctor === '[]') {
...
var _olligobber$proofcheck$Sequent$match1 = F2(
	function (small, big) {
		return A2(
			_olligobber$proofcheck$DictMerge$mergeDef,
			A2(_olligobber$proofcheck$WFF$match, small.conse, big.conse),
			A3(
				_elm_lang$core$List$foldl,
				_olligobber$proofcheck$DictMerge$mergeDef,
				_elm_lang$core$Maybe$Just(_elm_lang$core$Dict$empty),
				A3(_elm_lang$core$List$map2, _olligobber$proofcheck$WFF$match, small.ante, big.ante)));
	});
var _olligobber$proofcheck$Sequent$match = F2(
	function (small, big) {
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(small.ante),
			_elm_lang$core$List$length(big.ante)) ? A2(
			_elm_lang$core$List$filterMap,
			function (_p1) {
				var _p2 = _p1;
				var _p3 = A2(
					_olligobber$proofcheck$Sequent$match1,
					_elm_lang$core$Native_Utils.update(
						small,
						{ante: _p2._1}),
					big);
			...
			A2(
				...
				_elm_community$list_extra$List_Extra$permutations(
					A2(
						_elm_lang$core$List$indexedMap,
						F2(
							function (v0, v1) {
...
var _olligobber$proofcheck$Sequent$assignments = A2(
		...
		function (k, list) {
			return A2(
				...
				function (assign) {
					return {
						ctor: '::',
						_0: A3(_elm_lang$core$Dict$insert, k, true, assign),
						_1: {
							ctor: '::',
							_0: A3(_elm_lang$core$Dict$insert, k, false, assign),
							_1: {ctor: '[]'}
						}
					};
				},
...
var _olligobber$proofcheck$Sequent$seqVars = function (seq) {
	return A2(
		_elm_lang$core$Set$union,
		A3(
			_elm_lang$core$List$foldl,
			F2(
				function (w, v) {
					return A2(
						_elm_lang$core$Set$union,
						_olligobber$proofcheck$WFF$variables(w),
						v);
				}),
			_elm_lang$core$Set$empty,
			seq.ante),
		_olligobber$proofcheck$WFF$variables(seq.conse));
};
var _olligobber$proofcheck$Sequent$satisfies = F2(
	function (wff, assign) {
		return A2(
			...
			function (s) {
				return A2(
					...
					false,
					A2(_elm_lang$core$Dict$get, s, assign));
			},
			wff);
	});
var _olligobber$proofcheck$Sequent$filterWFF = F2(
	function (wff, list) {
		return A2(
			_elm_lang$core$List$filter,
			_olligobber$proofcheck$Sequent$satisfies(wff),
			list);
	});
var _olligobber$proofcheck$Sequent$verify = function (seq) {
	return A2(
		_elm_lang$core$List$all,
		_olligobber$proofcheck$Sequent$satisfies(seq.conse),
		A3(
			_elm_lang$core$List$foldl,
			_olligobber$proofcheck$Sequent$filterWFF,
			_olligobber$proofcheck$Sequent$assignments(
...
var _olligobber$proofcheck$Parser$convert = F2(
	function (_p0, tree) {
		var _p1 = _p0;
		var _p8 = _p1._0;
		var _p7 = _p1._1;
		...
		switch (_p2.ctor) {
			case 'Base':
				return _elm_lang$core$Result$Ok(
					_olligobber$proofcheck$WFF$Prop(_p2._0));
			case 'Unary':
				var _p4 = _p2._0;
				var _p3 = _p8(_p4);
				if (_p3.ctor === 'Nothing') {
					return _elm_lang$core$Result$Err(
						A2(_elm_lang$core$Basics_ops['++'], 'Parse Error: Unrecognised unary operator: ', _p4));
				} else {
					return A2(
						_elm_lang$core$Result$map,
						_p3._0,
						A2(
							_olligobber$proofcheck$Parser$convert,
			...
			default:
				...
				if (_p5.ctor === 'Nothing') {
					return _elm_lang$core$Result$Err(
						A2(_elm_lang$core$Basics_ops['++'], 'Parse Error: Unrecognised binary operator: ', _p6));
				} else {
					return A3(
...
var _olligobber$proofcheck$Parser$unexpectedError = function (c) {
	var _p9 = c;
	if (_p9.ctor === 'Just') {
		return _elm_lang$core$Result$Err(
			A2(
				...
				_elm_lang$core$String$fromChar(_p9._0)));
	} else {
		return _elm_lang$core$Result$Err('Parse Error: Unexpected end of input');
	}
};
var _olligobber$proofcheck$Parser$isNotSpace = function ($char) {
	return A2(
...
var _olligobber$proofcheck$Parser$isSymbol = function ($char) {
	return A2(
...
var _olligobber$proofcheck$Parser$toCategory = function (next) {
	var _p10 = next;
	if (_p10.ctor === 'Nothing') {
		...
		switch (_p11.valueOf()) {
			...
			case ')':
				return 4;
			default:
				return _olligobber$proofcheck$Parser$isProp(_p12) ? 0 : (_olligobber$proofcheck$Parser$isSymbol(_p12) ? 2 : -1);
		}
	}
};
var _olligobber$proofcheck$Parser$Binary = F3(
	function (a, b, c) {
		return {ctor: 'Binary', _0: a, _1: b, _2: c};
	});
var _olligobber$proofcheck$Parser$Unary = F2(
	function (a, b) {
		return {ctor: 'Unary', _0: a, _1: b};
	});
var _olligobber$proofcheck$Parser$Base = function (a) {
	return {ctor: 'Base', _0: a};
};
var _olligobber$proofcheck$Parser$Action = F2(
	function (a, b) {
		return {ctor: 'Action', _0: a, _1: b};
	});
var _olligobber$proofcheck$Parser$prod5 = {
	ctor: '::',
	_0: A2(
		_olligobber$proofcheck$Parser$Action,
		0,
		_elm_lang$core$Basics$always(
			_elm_lang$core$Result$Ok(
				_olligobber$proofcheck$Parser$Base('')))),
	_1: {ctor: '[]'}
};
var _olligobber$proofcheck$Parser$Symbol = function (a) {
	return {ctor: 'Symbol', _0: a};
};
var _olligobber$proofcheck$Parser$Letter = function (a) {
	return {ctor: 'Letter', _0: a};
};
var _olligobber$proofcheck$Parser$T = {ctor: 'T'};
var _olligobber$proofcheck$Parser$prod7 = {
	ctor: '::',
	_0: _olligobber$proofcheck$Parser$Letter(_olligobber$proofcheck$Parser$isSymbol),
	_1: {
		ctor: '::',
		_0: _olligobber$proofcheck$Parser$Symbol(_olligobber$proofcheck$Parser$T),
		_1: {
			ctor: '::',
			_0: A2(
				_olligobber$proofcheck$Parser$Action,
				...
				function (vals) {
					var _p13 = vals;
					if (((((_p13.ctor === '::') && (_p13._0.ctor === 'Base')) && (_p13._1.ctor === '::')) && (_p13._1._0.ctor === 'Base')) && (_p13._1._1.ctor === '[]')) {
						return _elm_lang$core$Result$Ok(
							_olligobber$proofcheck$Parser$Base(
								A2(_elm_lang$core$Basics_ops['++'], _p13._1._0._0, _p13._0._0)));
					} else {
						return _elm_lang$core$Result$Err('Parse Error: Action token 7 failed');
					}
				}),
			_1: {ctor: '[]'}
		}
...
var _olligobber$proofcheck$Parser$S = {ctor: 'S'};
var _olligobber$proofcheck$Parser$Q = {ctor: 'Q'};
var _olligobber$proofcheck$Parser$prod6 = {
	ctor: '::',
	_0: _olligobber$proofcheck$Parser$Letter(_olligobber$proofcheck$Parser$isProp),
	_1: {
		ctor: '::',
		_0: _olligobber$proofcheck$Parser$Symbol(_olligobber$proofcheck$Parser$Q),
		_1: {
			ctor: '::',
			_0: A2(
				_olligobber$proofcheck$Parser$Action,
				...
				function (vals) {
					var _p14 = vals;
					if (((((_p14.ctor === '::') && (_p14._0.ctor === 'Base')) && (_p14._1.ctor === '::')) && (_p14._1._0.ctor === 'Base')) && (_p14._1._1.ctor === '[]')) {
						return _elm_lang$core$Result$Ok(
							_olligobber$proofcheck$Parser$Base(
								A2(_elm_lang$core$Basics_ops['++'], _p14._1._0._0, _p14._0._0)));
					} else {
						return _elm_lang$core$Result$Err('Parse Error: Action token 6 failed');
					}
				}),
			_1: {ctor: '[]'}
		}
...
var _olligobber$proofcheck$Parser$P = {ctor: 'P'};
var _olligobber$proofcheck$Parser$prod3 = {
	ctor: '::',
	_0: _olligobber$proofcheck$Parser$Symbol(_olligobber$proofcheck$Parser$P),
	_1: {
		ctor: '::',
		_0: A2(
			_olligobber$proofcheck$Parser$Action,
			...
			function (vals) {
				...
				if ((_p15.ctor === '::') && (_p15._1.ctor === '[]')) {
					...
					return _elm_lang$core$Result$Err('Parse Error: Action token 3 failed');
				}
			}),
		_1: {ctor: '[]'}
	}
};
var _olligobber$proofcheck$Parser$C = {ctor: 'C'};
var _olligobber$proofcheck$Parser$B = {ctor: 'B'};
var _olligobber$proofcheck$Parser$prod1 = {
	ctor: '::',
	_0: _olligobber$proofcheck$Parser$Symbol(_olligobber$proofcheck$Parser$B),
	_1: {
		ctor: '::',
		_0: _olligobber$proofcheck$Parser$Symbol(_olligobber$proofcheck$Parser$C),
		_1: {
			ctor: '::',
			_0: A2(
				_olligobber$proofcheck$Parser$Action,
				...
				function (vals) {
					...
					do {
						if (((_p16.ctor === '::') && (_p16._1.ctor === '::')) && (_p16._1._1.ctor === '[]')) {
							switch (_p16._0.ctor) {
								case 'Base':
									return _elm_lang$core$Result$Ok(_p16._1._0);
								case 'Unary':
									return _elm_lang$core$Result$Ok(
										A3(_olligobber$proofcheck$Parser$Binary, _p16._1._0, _p16._0._0, _p16._0._1));
								default:
									break _v10_2;
							}
						} else {
					...
					return _elm_lang$core$Result$Err('Parse Error: Action token 1 failed');
				}),
			_1: {ctor: '[]'}
		}
	}
};
var _olligobber$proofcheck$Parser$prod2 = {
	ctor: '::',
	_0: _olligobber$proofcheck$Parser$Symbol(_olligobber$proofcheck$Parser$S),
	_1: {
		ctor: '::',
		_0: _olligobber$proofcheck$Parser$Symbol(_olligobber$proofcheck$Parser$B),
		_1: {
			...
			_0: A2(
				...
				function (vals) {
					var _p17 = vals;
					if ((((_p17.ctor === '::') && (_p17._1.ctor === '::')) && (_p17._1._0.ctor === 'Base')) && (_p17._1._1.ctor === '[]')) {
						return _elm_lang$core$Result$Ok(
							A2(_olligobber$proofcheck$Parser$Unary, _p17._1._0._0, _p17._0));
					} else {
						return _elm_lang$core$Result$Err('Parse Error: Action token 2 failed');
					}
				}),
			_1: {ctor: '[]'}
		}
...
var _olligobber$proofcheck$Parser$A = {ctor: 'A'};
var _olligobber$proofcheck$Parser$prod4 = {
	ctor: '::',
	_0: _olligobber$proofcheck$Parser$Letter(
		F2(
			function (x, y) {
				return _elm_lang$core$Native_Utils.eq(x, y);
			})(
				...
				_0: A2(
					...
					function (vals) {
						...
						if ((((_p18.ctor === '::') && (_p18._1.ctor === '::')) && (_p18._1._1.ctor === '::')) && (_p18._1._1._1.ctor === '[]')) {
							return _elm_lang$core$Result$Ok(_p18._1._0);
						} else {
							return _elm_lang$core$Result$Err('Parse Error: Action token 4 failed');
						}
					}),
				_1: {ctor: '[]'}
			}
...
var _olligobber$proofcheck$Parser$chooseProd = F2(
	function (next, symb) {
		var _p19 = {
			ctor: '_Tuple2',
			_0: symb,
			_1: _olligobber$proofcheck$Parser$toCategory(next)
		};
		_v13_17:
		do {
			if (_p19.ctor === '_Tuple2') {
				switch (_p19._1) {
					case 3:
						switch (_p19._0.ctor) {
							case 'C':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod5);
							case 'Q':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod5);
							default:
								break _v13_17;
					...
					case 0:
						switch (_p19._0.ctor) {
							case 'A':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod1);
							case 'B':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod3);
							case 'P':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod6);
							case 'Q':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod6);
							case 'T':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod5);
					...
					case 1:
						switch (_p19._0.ctor) {
							case 'A':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod1);
							case 'B':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod4);
							case 'T':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod5);
							default:
								break _v13_17;
					...
					case 2:
						switch (_p19._0.ctor) {
							case 'A':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod2);
							case 'C':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod2);
							case 'Q':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod5);
							case 'S':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod7);
							case 'T':
								return _elm_lang$core$Result$Ok(_olligobber$proofcheck$Parser$prod7);
							default:
								break _v13_17;
		...
		return _olligobber$proofcheck$Parser$unexpectedError(next);
	});
var _olligobber$proofcheck$Parser$parseStep = function (state) {
	var _p20 = state;
	_v14_5:
	do {
		_v14_4:
		do {
			if (_p20.ctor === '_Tuple3') {
				if (_p20._1.ctor === '[]') {
					if (_p20._0.ctor === '[]') {
						if ((_p20._2.ctor === '::') && (_p20._2._1.ctor === '[]')) {
							return _elm_lang$core$Result$Err(
								_elm_lang$core$Result$Ok(_p20._2._0));
						} else {
							break _v14_4;
						}
					} else {
					...
					switch (_p20._1._0.ctor) {
						case 'Letter':
							if (_p20._0.ctor === '::') {
								var _p21 = _p20._0._0;
								return _p20._1._0._0(_p21) ? _elm_lang$core$Result$Ok(
									{
										ctor: '_Tuple3',
										_0: _p20._0._1,
										_1: _p20._1._1,
										_2: {
											ctor: '::',
											_0: _olligobber$proofcheck$Parser$Base(
												_elm_lang$core$String$fromChar(_p21)),
											_1: _p20._2
										}
									}) : _elm_lang$core$Result$Err(
									_olligobber$proofcheck$Parser$unexpectedError(
						...
						case 'Action':
							var _p24 = _p20._2;
							var _p23 = _p20._1._0._0;
							var _p22 = _p20._1._0._1(
								A2(_elm_lang$core$List$take, _p23, _p24));
							if (_p22.ctor === 'Err') {
								return _elm_lang$core$Result$Err(
									_elm_lang$core$Result$Err(_p22._0));
							} else {
								return _elm_lang$core$Result$Ok(
									{
										ctor: '_Tuple3',
										...
										_2: {
											ctor: '::',
											_0: _p22._0,
											_1: A2(_elm_lang$core$List$drop, _p23, _p24)
										}
									});
							}
						default:
							var _p26 = _p20._0;
							var _p25 = A2(
								_olligobber$proofcheck$Parser$chooseProd,
								_elm_lang$core$List$head(_p26),
								_p20._1._0._0);
							if (_p25.ctor === 'Ok') {
								return _elm_lang$core$Result$Ok(
									{
										ctor: '_Tuple3',
										_0: _p26,
										_1: A2(_elm_lang$core$Basics_ops['++'], _p25._0, _p20._1._1),
										_2: _p20._2
									});
							} else {
								return _elm_lang$core$Result$Err(
									_elm_lang$core$Result$Err(_p25._0));
							}
					}
				}
			} else {
		...
		return _elm_lang$core$Result$Err(
			_olligobber$proofcheck$Parser$unexpectedError(_elm_lang$core$Maybe$Nothing));
	} while(false);
	return _elm_lang$core$Result$Err(
		_elm_lang$core$Result$Err('Parse Error: Invalid state'));
};
var _olligobber$proofcheck$Parser$parseFull = function (state) {
	return A2(
		_elm_lang$core$Result$andThen,
		_olligobber$proofcheck$Parser$parseFull,
...
var _olligobber$proofcheck$Parser$parse = F2(
	function (maps, string) {
		return A2(
			_elm_lang$core$Result$andThen,
			_olligobber$proofcheck$Parser$convert(maps),
		...
		return {
			...
			_1: function (s) {
				...
				switch (_p9) {
					...
					case '&':
						return _elm_lang$core$Maybe$Just(_olligobber$proofcheck$WFF$and);
					case '->':
						return _elm_lang$core$Maybe$Just(_olligobber$proofcheck$WFF$implies);
					default:
						return _elm_lang$core$Maybe$Nothing;
				}
			}
...
var _olligobber$proofcheck$CustomSymbol$toSequent2 = function (symbol) {
	return {
		ante: {
			ctor: '::',
			_0: symbol.definition,
			_1: {ctor: '[]'}
		},
		conse: symbol.wff
	};
};
var _olligobber$proofcheck$CustomSymbol$toSequent1 = function (symbol) {
	return {
		ante: {
			ctor: '::',
			_0: symbol.wff,
...
var _olligobber$proofcheck$CustomSymbol$makeBinary = F4(
	function (propa, propb, symbol, def) {
		return _elm_lang$core$Set$isEmpty(
			A2(
				_elm_lang$core$Set$diff,
				_olligobber$proofcheck$WFF$variables(def),
			...
			{
				name: symbol,
				wff: _olligobber$proofcheck$WFF$Binary(
					{
						fn: _olligobber$proofcheck$WFF$fromBin(
							F2(
								function (a, b) {
						...
						symbol: symbol,
						first: _olligobber$proofcheck$WFF$Prop(propa),
						second: _olligobber$proofcheck$WFF$Prop(propb)
					}),
				definition: def
			}) : _elm_lang$core$Result$Err('Extra propositions found in symbol definition');
	});
var _olligobber$proofcheck$CustomSymbol$makeUnary = F3(
	function (prop, symbol, def) {
		return _elm_lang$core$Set$isEmpty(
			A2(
				_elm_lang$core$Set$diff,
				_olligobber$proofcheck$WFF$variables(def),
				_elm_lang$core$Set$singleton(prop))) ? _elm_lang$core$Result$Ok(
			{
				name: symbol,
				wff: _olligobber$proofcheck$WFF$Unary(
					{
						fn: _olligobber$proofcheck$WFF$fromUn(
							function (b) {
								return A2(
									_olligobber$proofcheck$WFF$eval,
									_elm_lang$core$Basics$always(b),
									def);
							}),
						symbol: symbol,
						contents: _olligobber$proofcheck$WFF$Prop(prop)
					}),
				definition: def
			}) : _elm_lang$core$Result$Err('Extra propositions found in symbol definition');
	});
var _olligobber$proofcheck$CustomSymbol$Symbol = F3(
	function (a, b, c) {
		return {name: a, wff: b, definition: c};
	});

var _olligobber$proofcheck$Proof$ruleSequent = F2(
	function (proof, rule) {
		var _p0 = rule;
		switch (_p0.ctor) {
			case 'Assumption':
				return {
					ctor: '::',
					_0: _olligobber$proofcheck$Sequent$ass,
					_1: {ctor: '[]'}
				};
			case 'ModusPonens':
				return {
					ctor: '::',
					_0: _olligobber$proofcheck$Sequent$mp,
					_1: {ctor: '[]'}
				};
			case 'ModusTollens':
				return {
					ctor: '::',
					_0: _olligobber$proofcheck$Sequent$mt,
					_1: {ctor: '[]'}
				};
			case 'DoubleNegation':
				return {
					ctor: '::',
					_0: _olligobber$proofcheck$Sequent$dn1,
					_1: {
						ctor: '::',
						_0: _olligobber$proofcheck$Sequent$dn2,
						_1: {ctor: '[]'}
					}
				};
			case 'ConditionalProof':
				return {
					ctor: '::',
					_0: _olligobber$proofcheck$Sequent$cp,
					_1: {ctor: '[]'}
				};
			case 'AndIntroduction':
				return {
					ctor: '::',
					_0: _olligobber$proofcheck$Sequent$ai,
					_1: {ctor: '[]'}
				};
			case 'AndElimination':
				return {
					ctor: '::',
					_0: _olligobber$proofcheck$Sequent$ae1,
					_1: {
						ctor: '::',
						_0: _olligobber$proofcheck$Sequent$ae2,
						_1: {ctor: '[]'}
					}
				};
			case 'OrIntroduction':
				return {
					ctor: '::',
					_0: _olligobber$proofcheck$Sequent$oi1,
					_1: {
						ctor: '::',
						_0: _olligobber$proofcheck$Sequent$oi2,
						_1: {ctor: '[]'}
					}
				};
			case 'OrElimination':
				return {
					ctor: '::',
					_0: _olligobber$proofcheck$Sequent$oe,
					_1: {ctor: '[]'}
				};
			case 'RAA':
				return {
					ctor: '::',
					_0: _olligobber$proofcheck$Sequent$raa,
					_1: {ctor: '[]'}
				};
			case 'Definition':
				var _p1 = A2(_elm_community$list_extra$List_Extra_ops['!!'], proof.symbols, _p0._0);
				if (_p1.ctor === 'Just') {
					var _p2 = _p1._0;
					return {
						ctor: '::',
						_0: _olligobber$proofcheck$CustomSymbol$toSequent1(_p2),
						_1: {
							ctor: '::',
							_0: _olligobber$proofcheck$CustomSymbol$toSequent2(_p2),
							_1: {ctor: '[]'}
						}
					};
				} else {
...
var _olligobber$proofcheck$Proof$getAll = A2(
	_elm_lang$core$List$foldl,
	F2(
		function (mb, mlist) {
			var _p3 = {ctor: '_Tuple2', _0: mb, _1: mlist};
			if (((_p3.ctor === '_Tuple2') && (_p3._0.ctor === 'Just')) && (_p3._1.ctor === 'Just')) {
				return _elm_lang$core$Maybe$Just(
					A2(
						_elm_lang$core$Basics_ops['++'],
	...
	_elm_lang$core$Maybe$Just(
		{ctor: '[]'}));
var _olligobber$proofcheck$Proof$makeSequent = F2(
	function (proof, deduction) {
		var _p4 = _olligobber$proofcheck$Proof$getAll(
			A2(
				_elm_lang$core$List$map,
				function (i) {
					return A2(_elm_community$list_extra$List_Extra_ops['!!'], proof.lines, i);
				},
				deduction.reasons));
		if (_p4.ctor === 'Nothing') {
			return _elm_lang$core$Result$Err('Line referenced was not found in the proof');
		} else {
			return _elm_lang$core$Result$Ok(
				{
					ante: A2(
...
var _olligobber$proofcheck$Proof$applyPerm = F2(
	function (list, indices) {
		return _olligobber$proofcheck$Proof$getAll(
			A2(
				_elm_lang$core$List$map,
				F2(
					function (x, y) {
...
var _olligobber$proofcheck$Proof$matchDeduction = F2(
	function (proof, deduction) {
		return A2(
			_elm_lang$core$Result$map,
			_elm_lang$core$List$filterMap(
				_olligobber$proofcheck$Proof$applyPerm(proof.lines)),
			A2(
				_elm_lang$core$Result$map,
				_elm_lang$core$List$filterMap(
					_olligobber$proofcheck$Proof$applyPerm(deduction.reasons)),
				A2(
					_elm_lang$core$Result$map,
					...
					A2(
						...
						function (ded) {
							return A2(
								_elm_lang$core$List$concatMap,
								A2(_elm_lang$core$Basics$flip, _olligobber$proofcheck$Sequent$match, ded),
								A2(_olligobber$proofcheck$Proof$ruleSequent, proof, deduction.rule));
						},
						A2(_olligobber$proofcheck$Proof$makeSequent, proof, deduction)))));
	});
...
var _olligobber$proofcheck$Proof$empty = {
	sequents: {ctor: '[]'},
	symbols: {ctor: '[]'},
	lines: {ctor: '[]'},
	assumptions: 0
};
var _olligobber$proofcheck$Proof$showRule = F2(
	function (proof, rule) {
		var _p5 = rule;
		switch (_p5.ctor) {
			case 'Assumption':
			...
			case 'RAA':
				return 'RAA';
			case 'Definition':
				var _p6 = A2(_elm_community$list_extra$List_Extra_ops['!!'], proof.symbols, _p5._0);
				if (_p6.ctor === 'Nothing') {
					return 'Internal Error with Symbol Definition';
				} else {
					return A2(
						_elm_lang$core$Basics_ops['++'],
						'Def (',
...
var _olligobber$proofcheck$Proof$showReason = F2(
	function (proof, ded) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_olligobber$proofcheck$Proof$showRule, proof, ded.rule),
			A2(
				_elm_lang$core$Basics_ops['++'],
				' ',
				_olligobber$proofcheck$Proof$niceList(
					A2(
						_elm_lang$core$List$map,
						F2(
							function (x, y) {
...
var _olligobber$proofcheck$Proof$Deduction = F4(
	function (a, b, c, d) {
		return {assumptions: a, deduction: b, rule: c, reasons: d};
	});
var _olligobber$proofcheck$Proof$Proof = F4(
	function (a, b, c, d) {
		return {sequents: a, symbols: b, lines: c, assumptions: d};
	});
var _olligobber$proofcheck$Proof$Introduction = function (a) {
	return {ctor: 'Introduction', _0: a};
};
var _olligobber$proofcheck$Proof$Definition = function (a) {
	return {ctor: 'Definition', _0: a};
};
var _olligobber$proofcheck$Proof$RAA = {ctor: 'RAA'};
var _olligobber$proofcheck$Proof$OrElimination = {ctor: 'OrElimination'};
var _olligobber$proofcheck$Proof$OrIntroduction = {ctor: 'OrIntroduction'};
var _olligobber$proofcheck$Proof$AndElimination = {ctor: 'AndElimination'};
var _olligobber$proofcheck$Proof$AndIntroduction = {ctor: 'AndIntroduction'};
var _olligobber$proofcheck$Proof$ConditionalProof = {ctor: 'ConditionalProof'};
var _olligobber$proofcheck$Proof$DoubleNegation = {ctor: 'DoubleNegation'};
var _olligobber$proofcheck$Proof$ModusTollens = {ctor: 'ModusTollens'};
var _olligobber$proofcheck$Proof$ModusPonens = {ctor: 'ModusPonens'};
				...
				case 'ConditionalProof':
					...
					if (_p11.ctor === '[]') {
						...
						if (((_p11._0.ctor === '::') && (_p11._0._1.ctor === '::')) && (_p11._0._1._1.ctor === '[]')) {
							...
							return _elm_lang$core$Result$Err('Internal error when adding deduction: Conditional Proof');
						}
					}
				case 'RAA':
					var _p14 = A2(
					...
					if (_p14.ctor === '[]') {
						...
						if (((_p14._0.ctor === '::') && (_p14._0._1.ctor === '::')) && (_p14._0._1._1.ctor === '[]')) {
							...
							return _elm_lang$core$Result$Err('Internal error when adding deduction: RAA');
						}
					}
				case 'OrElimination':
					var _p21 = A2(
					...
					if (_p21.ctor === '[]') {
						...
						if ((((((_p21._0.ctor === '::') && (_p21._0._1.ctor === '::')) && (_p21._0._1._1.ctor === '::')) && (_p21._0._1._1._1.ctor === '::')) && (_p21._0._1._1._1._1.ctor === '::')) && (_p21._0._1._1._1._1._1.ctor === '[]')) {
							...
							return _elm_lang$core$Result$Err('Internal error when adding deduction: Or Elimination');
						}
					}
				default:
					var _p22 = _p8._1._0;
									...
									lines: A2(
										...
										proof.lines,
										{
											...
											_0: _elm_lang$core$Native_Utils.update(
												$new,
												{
													assumptions: _elm_community$list_extra$List_Extra$unique(
														_elm_lang$core$List$sort(
															A2(
																_elm_lang$core$List$concatMap,
																function (_) {
...
var _olligobber$proofcheck$SequentUI$selectSeq = function (proof) {
	...
	if (_p0.ctor === '[]') {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('sequent-dropdown'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _olligobber$proofcheck$SequentUI$renderNewSeq = function ($new) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('new-sequent'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
						...
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('ante-input'),
										_1: {ctor: '[]'}
									}
								}
							}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('seq-symbol'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
								...
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$id('conse-input'),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _olligobber$proofcheck$SequentUI$renderSequents = F2(
	function (proof, $new) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('sequent-list'),
				_1: {ctor: '[]'}
			},
			A3(
...
var _olligobber$proofcheck$SymbolUI$selectSym = function (proof) {
	...
	if (_p0.ctor === '[]') {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('symbol-dropdown'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		switch (_p2.ctor) {
			...
			default:
				return _elm_lang$core$Native_Utils.update(
					old,
					{
						binary: _elm_lang$core$Native_Utils.eq(_p2._0, 'B')
					});
		}
	});
var _olligobber$proofcheck$SymbolUI$blank = {name: '', definition: '', binary: true};
var _olligobber$proofcheck$SymbolUI$NewSymbol = F3(
	function (a, b, c) {
		return {name: a, definition: b, binary: c};
	});
var _olligobber$proofcheck$SymbolUI$Binary = function (a) {
	return {ctor: 'Binary', _0: a};
};
var _olligobber$proofcheck$SymbolUI$Def = function (a) {
	return {ctor: 'Def', _0: a};
};
var _olligobber$proofcheck$SymbolUI$Name = function (a) {
...
var _olligobber$proofcheck$SymbolUI$renderNewSym = function ($new) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('new-symbol'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_elm_lang$html$Html$select,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id('operator-select'),
								_1: {ctor: '[]'}
							}
						},
						{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('symbol-name'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
								...
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$id('choose-name'),
												_1: {ctor: '[]'}
											}
										}
									}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('equiv-symbol'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('symbol-def'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_olligobber$proofcheck$SymbolUI$Def),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value($new.definition),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$id('set-def'),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _olligobber$proofcheck$SymbolUI$renderSymbols = F2(
	function (proof, $new) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('symbol-list'),
				_1: {ctor: '[]'}
			},
			A3(
				_elm_lang$core$Basics$flip,
...
var _olligobber$proofcheck$ProofUI$submitLine = F2(
	function (proof, newline) {
		return A2(
			_elm_lang$core$Result$andThen,
			_olligobber$proofcheck$Proof$addDeduction(proof),
			A4(
				...
				A2(
					...
					A2(
						...
						_olligobber$proofcheck$CustomSymbol$makeMap(proof.symbols),
						newline.formula)),
				A2(_elm_lang$core$Result$fromMaybe, 'Incomplete reason', newline.reason),
				A2(
					_elm_lang$core$Result$mapError,
					F2(
						function (x, y) {
...
var _olligobber$proofcheck$ProofUI$renderNewLine = F2(
	function (indexing, proof) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('new-line'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$id('formula-input'),
												_1: {ctor: '[]'}
											}
										}
									},
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$select,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$id('reason-dropdown'),
												_1: {ctor: '[]'}
											}
										},
										A2(
													...
													_elm_lang$html$Html$option,
													{
														...
														_1: {
															...
															_0: _elm_lang$html$Html_Attributes$selected(
																_elm_lang$core$Native_Utils.eq(x, 'A')),
															_1: {ctor: '[]'}
														}
													},
													{
...
var _olligobber$proofcheck$ProofUI$renderLines = F2(
	function (proof, newline) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('proof-lines'),
				_1: {ctor: '[]'}
			},
			A3(
				_elm_lang$core$Basics$flip,
...
var _olligobber$proofcheck$Main$closeButton = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onClick(
			_olligobber$proofcheck$Main$Open(_olligobber$proofcheck$Main$NoWindow)),
		_1: {
			ctor: '::',
...
var _olligobber$proofcheck$Main$sequentBox = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('sequent-box'),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _olligobber$proofcheck$Main$symbolBox = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('symbol-box'),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _olligobber$proofcheck$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _olligobber$proofcheck$Main$menu(model),
			_1: {
				ctor: '::',
				_0: _olligobber$proofcheck$Main$activeBox(model),
				_1: {
					ctor: '::',
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _olligobber$proofcheck$Main$main !== 'undefined') {
    _olligobber$proofcheck$Main$main(Elm['Main'], 'Main', undefined);
}
